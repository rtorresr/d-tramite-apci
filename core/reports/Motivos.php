...
<page backtop="25mm" backbottom="10mm" backleft="10mm" backright="10mm">
    ...
    <table style="width: 100%; border: solid 0px black;">
        <tr>
            <td style="text-align: left;	width: 50%"><span style="font-size: 15px; font-weight: bold">REPORTE DE MOTIVOS</span></td>
    ...
    <table style="width: 70%;border: solid 1px #5544DD; border-collapse: collapse" align="center">
        <thead>
        <tr>
            <th style="width: 60%; text-align: center; border: solid 1px #6F6F6F; background: #D8D8D8">DESCRIPCIÓN</th>
        </tr>
        </thead>
        <tbody>
        <?php
        ...
        while ($Rs=sqlsrv_fetch_array($rs)){
            ?>
            <tr>
                <td style="width: 60%; text-align: left; border: solid 1px #6F6F6F;font-size:10px"><?php echo utf8_encode($Rs['cIndicacion']??'');?></td>
            </tr>
            <?php
        }
        ?>
