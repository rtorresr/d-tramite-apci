...
<div class="form-group border-bottom"> 
        ...
        <div class="row">
            <div class="col-5">
                <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="chxSigcti">Cuento con un trámite ante el SIGCTI</label>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-5">
                <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="cboCudExist">Cuento con un CUD y
                        continuaré un trámite ya iniciado</label>
                </div>
            </div>

            <div class="col-2" id="nroExp">
    ...
    <div class="form-group sigcti">
        <div class="row">
            <div class="col">
                <label for="txtClaseProc">Tipo de trámite</label>
                <select class="form-control" id="txtClaseProc" name="txtClaseProc" onChange="docTupa()">
                    <option value="">General</option>
                    <option value="3">Tramites específicos</option>
                    <option value="1">Trámites administrativos</option>
                </select>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="custom-file">
                    <input type="file" class="custom-file-input" id="archivoPrincipal" lang="es" required>
    ...
    <div class="form-group sigcti tupa" style="display:none" id="docTupaDocumentos">
        <div class="row">
            <div class="col-sm-12" style="width: 100%!important">
                ...
                <small class="form-text text-muted">Los archivos deben estar en formato .pdf, .xlsx, .docx</small>
            </div>
        </div>
    </div>
