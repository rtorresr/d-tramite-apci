<form id="FormRemitente">
    ...
    <div class="form-group">
        <div class="alert alert-warning" role="alert">
                Estimado Usuario/a debido a problemas técnicos con RENIEC, se solicita que realizar el registro de datos de forma manual.
        ...
        <div class="row"> 
            ...
            <div class="col" id="htmlNombreR">
                ...
                <input class="form-control" id="txtNombComp" type="text" placeholder="Ej. JUAN SOTO SANCHEZ" required>
            </div>
        </div>
    </div>
    <div class="form-group">
