...
/* * ************************************************************************************
  ...
  -> Eliminar Registro de Grupo de Oficinas
  ...
  ------------------------------------------------------------------------
 * *************************************************************************************** */
$sql1 = "DELETE FROM Tra_M_Grupo_Oficina_Detalle WHERE iCodGrupoOficina = " . $id;
$sql2 = "DELETE FROM Tra_M_Grupo_Oficina WHERE iCodGrupoOficina = " . $id;
