...
header("Content-Disposition: attachment; filename=ReporteFinalizadosGenerales.xls");
  ...
  while ($RsTra=sqlsrv_fetch_array($rsTra)){
  	echo "<tr>";
		...
		echo date("d-m-Y", strtotime($RsTra['fFecDocumento']));
		echo date("h:i A", strtotime($RsTra['fFecDocumento']));
		echo "</td>";
		echo "<td valign=top><br>";
		echo date("d-m-Y", strtotime($RsTra['fFecDerivar']));
		echo date("h:i A", strtotime($RsTra['fFecDerivar']));
		echo "</td>";
		echo "<td valign=top>";
        	if($RsTra['fFecRecepcion']==""){
        			...
        			echo "<div style=color:#0154AF;font-size:10px;text-align:center>".date("h:i A", strtotime($RsTra['fFecRecepcion']))."</div>";
        	}
		echo "</td>";
		echo "<td valign=top>";
           			echo "<div style=color:#0154AF;text-align:center>".date("d-m-Y", strtotime($RsTra[fFecFinalizar]))."</div>";
        			echo "<div style=color:#0154AF;font-size:10px;text-align:center>".date("h:i A", strtotime($RsTra[fFecFinalizar]))."</div>";
		echo "</td>";
		...
		echo "<td valign=top>";
        	if($RsTra['fFecDelegadoRecepcion']==""){
        			...
        			echo "<div style=color:#0154AF;text-align:center>".date("d-m-Y", strtotime($RsTra['fFecDelegadoRecepcion']))."</div>";
        			echo "<div style=color:#0154AF;font-size:10px;text-align:center>".date("h:i A", strtotime($RsTra['fFecDelegadoRecepcion']))."</div>";
        	}
		echo "</td>";
