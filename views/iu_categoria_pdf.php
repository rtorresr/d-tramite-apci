<?
/**************************************************************************************
NOMBRE DEL PROGRAMA: iu_categoria_pdf.php
SISTEMA: SISTEMA   DE TRÁMITE DOCUMENTARIO DIGITAL
OBJETIVO: Reporte general en PDF de la Tabla Categorias
...
<page backtop="25mm" backbottom="10mm" backleft="10mm" backright="10mm">
	...
	<table style="width: 100%; border: solid 0px black;">
	<tr>
	<td style="text-align: left;	width: 50%"><span style="font-size: 15px; font-weight: bold">REPORTE - CATEGORIAS</span></td>
	...
	<table style="width: 60%;border: solid 1px #5544DD; border-collapse: collapse" align="center">
		<thead>
			<tr>
 				<th style="width: 40%; text-align: center; border: solid 1px #6F6F6F; background: #D8D8D8">CATEGORIA</th>
			</tr>
		</thead>
		<tbody>
	<?
	...
	?>
		<tr>
        <td style="width: 40%; text-align: left; border: solid 1px #6F6F6F;font-size:10px"><?php echo $Rs[cDesCategoria];?></td>
        </tr>
	<?
        }
    ?>
