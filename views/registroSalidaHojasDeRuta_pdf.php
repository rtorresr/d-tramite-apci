<?
/**************************************************************************************
NOMBRE DEL PROGRAMA: registroSalidaHojasDeRuta_pdf.php
...
$sql.=" WHERE Tra_M_Tramite.iCodTramite='$_GET[iCodTramite]' and iCodOficinaDerivar != 1 ";
...
<page backtop="15mm" backbottom="10mm" backleft="10mm" backright="10mm">
  ...
  <td style="width: 100%; text-align: center; border: solid 1px #585858;">
  		...
  		<td style="width:2%;text-align:left; border: solid 0px #585858;font-size:14px">:</td>
  		<td style="width:65%;text-align:left; border: solid 0px #585858;font-size:14px;text-transform:uppercase;font-family:Times"><b><?php echo " ".$Rs[cReferencia];?></b></td>
  		</tr>
         ...
         <tr>
  		<td style="width:23%;height:10px;text-align:left; border: solid 0px #585858;font-size:14px;font-family:Times">Instituci&oacute;n Destino</td>
  		<td style="width:2%;text-align:left; border: solid 0px #585858;font-size:14px">:</td>
  		<td style="width:65%;text-align:left; border: solid 0px #585858;font-size:14px;font-family:Times"><b>
				<?
				if($Rs[iCodRemitente]>0){
				$sqlRemite=" SELECT cNombre FROM Tra_M_Remitente WHERE iCodRemitente=$Rs[iCodRemitente] ";
				$rsRemite=sqlsrv_query($cnx,$sqlRemite);
			    $RsRemite=sqlsrv_fetch_array($rsRemite);
        ...
        $RsCarg=sqlsrv_fetch_array($rsCarg);
			    ...
			    echo $RsRemite['cNombre'];
				}
				else if($Rs[iCodRemitente]==0){
				echo "MULTIPLES DESTINOS";
				}
				else{
				echo "SIN ASIGNAR DESTINO";
				}
				?>
  			</b>
  		</td>
        ...
        <tr>
  		<td style="width:23%;height:10px;text-align:left; border: solid 0px #585858;font-size:14px;font-family:Times">Destinatario</td>
  		<td style="width:2%;text-align:left; border: solid 0px #585858;font-size:14px">:</td>
  		<td style="width:65%;text-align:left; border: solid 0px #585858;font-size:14px;font-family:Times"><b>
				<?
			    echo trim($Rs[cNomRemite]);
				?>
  			</b>
  		</td>
  		</tr>
        <tr>
  		<td style="width:23%;height:10px;text-align:left; border: solid 0px #585858;font-size:14px;font-family:Times">Domicilio</td>
  		<td style="width:2%;text-align:left; border: solid 0px #585858;font-size:14px">:</td>
  		<td style="width:65%;text-align:left; border: solid 0px #585858;font-size:14px;font-family:Times"><b>
				<?
	  ...
	  echo $dir." - ".$RsDep[cNomDepartamento]." - ".$RsPro[cNomProvincia]." - ".$RsDis[cNomDistrito];
				?>
  			</b>
  		</td>
  		</tr>	        		
  ...
  <td style="width: 100%; text-align:left; border: solid 1px #585858;font-family:Times">
   <?  echo $Rs['cAsunto'];
	...
	<table style="width:100%;border: solid 0px #585858; border-collapse: collapse" align="left">
	<tr>
	<td style="width:100%;height:20px;text-align:left; vertical-align:bottom; border: solid 0px #585858;font-family:Times">&nbsp;</td>
	</tr>
	</table>
