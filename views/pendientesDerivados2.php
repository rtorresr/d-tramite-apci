...
<div class="AreaTitulo">documentos derivados</div>	
...
// ordenamiento
if($_GET['campo']==""){
	$campo="Tra_M_Tramite_Movimientos.fFecDerivar";
}Else{
	$campo=$_GET['campo'];
}
...
///////////////////////////////////////////////////////		
      ...
      ?>
        ...
        <td align="left" valign="middle"><?=$RsTra[cAsuntoDerivar]?></td>
        ...
        <td valign="midddle" align="center">
        	<?
