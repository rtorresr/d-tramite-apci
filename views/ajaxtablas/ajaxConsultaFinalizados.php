...
$VI_FFECREGISTRO_INICIO = $_POST['VI_FFECREGISTRO_INICIO'] =="" ? '01/01/2019' : $_POST['VI_FFECREGISTRO_INICIO'];
$VI_FFECREGISTRO_FINAL = $_POST['VI_FFECREGISTRO_FINAL'] =="" ? '31/12/2019' : $_POST['VI_FFECREGISTRO_FINAL'];
...
$start =0;//$_POST["start"]=="" ? 0 : $_POST["start"];
$length =10;// $_POST["length"]=="" ? 10 : $_POST["length"];

//echo $start; 
$sqlConsulta = "execute SP_CONSULTA_DOCUMENTOS_FINALIZADOS '".$VI_NCUD."',".$VI_ICODOFICINAREGISTRO.",'".$VI_FFECREGISTRO_INICIO."','".$VI_FFECREGISTRO_FINAL."','".$VI_CCODIFICACION."',".$start.",". $length;
