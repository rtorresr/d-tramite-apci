<?
/**************************************************************************************
NOMBRE DEL PROGRAMA: iu_correlativo_trabajador.php
SISTEMA: SISTEMA  DE TR�MITE DOCUMENTARIO DIGITAL
OBJETIVO: Administrar Tabla Maestra de correlativos de Documentos del Profesional para el Perfil Administrador 
...
function releer(){
  document.form1.action="<?=$_SERVER['PHP_SELF']?>#area";
  document.form1.submit();
}
</script>
 ...
 <table width="950" border="0" align="center" >
  <tr>
   ...
   <table width="900" border="0" align="center">
    <tr>
    <td width="262" height="38" >Oficina:</td>
    <td width="148" ><select name="iCodOficina" class="FormPropertReg form-control" style="width:350px" onChange="releer();" >
    ...
    <td width="87" >Pofesional:</td>
    <td width="385" align="left">	<select name="iCodTrabajador" style="width:340px;" class="FormPropertReg form-control">
							<?
							$sqlTrb="SELECT * FROM Tra_M_Trabajadores WHERE iCodOficina='$_GET['iCodOficina']' ORDER BY iCodCategoria DESC, cNombresTrabajador ASC";
              $rsTrb=sqlsrv_query($cnx,$sqlTrb);
              while ($RsTrb=sqlsrv_fetch_array($rsTrb)){
              	if($RsTrb[iCodTrabajador]==$_GET[iCodTrabajador]){
              		$selecTrab="selected";
              	}Else{
              		$selecTrab="";
              	}
...
$sql=" SP_CORRELATIVO_PROFESIONAL_LISTA '$_GET[iCodTrabajador]' ";
//echo $sql;
/*
$sql="select * from Tra_M_Oficinas ";
$sql.=" WHERE iCodOficina>0 ";
...
?>
<tr>
<td align="center" colspan="2"><button class="btn btn-primary" type="submit" onMouseOver="this.style.cursor='hand'"> <b>Registrar</b>  </button></td>
<tr>
<?
}
?>
...
<?php echo paginar($pag, $total, $tampag, "iu_correlativo_trabajador.php?iCodOficina=".$_GET['iCodOficina']."&iCodTrabajador=".$_GET[iCodTrabajador]."&pag=");?>
<table width="900" border="0" align="center">
  <tr>
    <td align="right"><a href='iu_nuevo_corre_trab.php?iCodOficina=<?=$_GET['iCodOficina']?>&iCodTrabajador=<?=$_GET[iCodTrabajador]?>'>Nuevo Correlativo</a>&nbsp;&nbsp;</td>
  </tr>
</table>
