...
<div class="AreaTitulo">Maestra correlativos - internos</div>
        ...
        <table border="0">
           ...
           <tr>
              ...
              <button class="btn btn-primary"  type="submit" id="Insert Oficina"   onMouseOver="this.style.cursor='hand'"> <b>Crear</b> <img src="images/page_add.png" width="17" height="17" border="0"> </button>
				...
				<button class="btn btn-primary" type="button" onclick="window.open('cst_correlativo_interno.php?iCodOficina=<?=$_GET['iCodOficina']?>', '_self');" onMouseOver="this.style.cursor='hand'"> <b>Cancelar</b> <img src="images/icon_retornar.png" width="17" height="17" border="0"> </button>              </td>
           </tr>
        </table>
        </fieldset>
