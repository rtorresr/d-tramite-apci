...
<form action="../controllers/ln_actualiza_grupo_tramite.php" onSubmit="return validar(this)" method="post" name="form1">
<input name="txtcod_grupo" type="hidden" id="txtcod_grupo" value="<?php echo $Rs[iCodGrupoTramite]; ?>">
        ...
        <table border="0">
           <tr>
              ...
              <input name="txtgrupo" type="text" id="txtgrupo"  maxlength="30" value="<?php echo trim($Rs[cDesGrupoTramite]); ?>" size="40" class="FormPropertReg form-control">
              </td>
           </tr>
           <tr>
