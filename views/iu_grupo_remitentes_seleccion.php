...
<div class="AreaTitulo">Seleccione Remitente:</div>	
		<table width="100%" border="1" cellpadding="0" cellspacing="3">
            ...
            <input type="hidden" name="iCodGrupo" value="<?=$_GET[iCodGrupo]?>">
       	<tr>
			...
			Nro. Documento: <input type="text" name="nNumDocumento" value="<?=$_GET['nNumDocumento']?>" size="10">
             &nbsp;&nbsp;&nbsp;
			Sigla de Remitente: <input type="text" name="cSiglaRemitente" value="<?=$_GET[cSiglaRemitente]?>" size="20">
            &nbsp;&nbsp;&nbsp;
		...
		<form method="POST" name="formulario" action="../controllers/ln_nuevo_grupo_remitente_detalle.php" target="_parent">
       	<input type="hidden" name="codGrupo" value="<?=$_GET[iCodGrupo]?>">
        ...
        <tr>
		  ...
		  <td align="center"    width="510">Remitente</td>
			<td align="center"    width="90">Nro. de Documento</td>
            <td align="center"    width="90">Sigla de Remitente</td>
		</tr>
		<?
		
		include_once("../conexion/conexion.php");
		if($_GET[cNombreBuscar]!="" or $_GET['nNumDocumento']!="" or $_GET[cSiglaRemitente]!="" ){
		$sqlRem="SELECT * FROM Tra_M_Remitente WHERE iCodRemitente NOT IN ";
		$sqlRem.=" (SELECT Tra_M_Remitente.iCodRemitente FROM Tra_M_Remitente,Tra_M_Grupo_Remitente_Detalle ";
        $sqlRem.=" WHERE Tra_M_Remitente.iCodRemitente=Tra_M_Grupo_Remitente_Detalle.iCodRemitente  ";
        $sqlRem.=" AND iCodGrupo='$_GET[iCodGrupo]') ";
