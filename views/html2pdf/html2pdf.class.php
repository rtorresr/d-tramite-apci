...
if (!defined('__CLASS_HTML2PDF__'))
{
	...
	class HTML2PDF
	{
		 ...
		 * @return	null
		 */
		public function __construct($sens = 'P', $format = 'A4', $langue='es', $unicode=true, $encoding='UTF-8', $marges = array(5, 5, 5, 8))
		{
