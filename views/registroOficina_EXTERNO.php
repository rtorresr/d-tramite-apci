...
if($_SESSION['CODIGO_TRABAJADOR']!=""){
    ...
    <main>
            ...
            <?php                
                if(isset($_GET['dtr']) && trim($_GET['dtr']) != ''){
                    ...
                    if (isset($informacion->documentos)){
                        ...
                        ?>
                        <input type='hidden' value='<?=json_encode($tramitesRspt)?>' name='tramitesRspt'>
                ...
                ?>                        
                    ...
                    <?php
                        $cAgrupado = $informacion->agrupado;
        ...
        <div class="container">
                ...
                <input type="hidden" name="cAgrupado" id="cAgrupado" value="<?=$cAgrupado??0?>">
                            ...
                            <div class="card-body">
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s12 m3 input-field">
                                            <select name="cCodTipoDoc" id="cCodTipoDoc" class="FormPropertReg form-control"></select>
                                        ...
                                        <div class="col m12">
                                            <div id="areaOficina">
                                                ...
                                                <div class="row" id="paraOficinas">
                                                    <div class="col s12 m6 input-field">
                                                        <select name="iCodOficinaO" id="iCodOficinaO"></select>
                                ...
                                <fieldset style="display: none" id="destinoExterno">
                                    ...
                                    <div class="row" id="nombreDestinoExternocol">
                                        <div class="col m9 input-field">
                                            ...
                                            <p style="color:green; font-size:14px; display:none" id="avisoCasillaElectronica"><strong>La entidad cuenta con casilla electrónica con asiento: <span></span></strong></p>
                                        </div>
                                        <input type="hidden" id="flgRequiereDireccion" value="1">
                                    ...
                                    <p style="padding-left: 1rem"><b>Datos de despacho</b></p>
                                    <div class="row">
                                        <div class="col s12 m6 input-field">
                                    ...
                                    <div class="row" id="datosCasilla" style="display: none;">
                                        <input type="hidden" name="IdPersonaExterna" id="IdPersonaExterna" value="0">
                                        <div class="col s12 m6 input-field">
                                            <input type="number" id="FoliosDespacho" name="FoliosDespacho">
                                            <label for="FoliosDespacho">Folios total del expediente</label>
                                        </div>
                                    </div>
    ...
    <input type="hidden" id="idTraP" value="">
    ...
    <input type="hidden" id="idEntidad" value="">
    
    <!-- <input type="hidden" id="idTramiteNotificacion" value="">
    <input type="hidden" id="flgNotificacion" value="">
    <input type="hidden" id="iCodDocPrincipal" value="">
    <input type="hidden" id="flgFirmaDocPrincipal" value="">
    <input type="hidden" id="flgFirmaCedulaNotificacion" value=""> -->
    ...
    <div id="modalDoc" class="modal modal-fixed-footer modal-fixed-header">
        <div class="modal-header">
            <div class="row">
                ...
                <div class="col s6" style="text-align: right">
                    Documento 
                    <span id="textActualVer"></span> de 
                    <span id="textTotalVer"></span>
                    <a class="btn btn-link" id="btnAnteriorVer"><i class="fas fa-chevron-left"></i></a>
                    <a class="btn btn-link" id="btnSiguienteVer"><i class="fas fa-chevron-right"></i></a> 
                </div> 
            </div>            
        </div>
        ...
        <div class="modal-footer">
            <a class="modal-close waves-effect waves-green btn-flat" id="btnCerrarNormal">Cerrar</a>
            <a class="waves-effect waves-green btn-flat" id="btnCerrarDocFirmado" style="display:none">Cerrar</a>
        </div>
    </div>
    ...
    <!-- <div id="modalDocFirmado" class="modal modal-fixed-footer modal-fixed-header">
        ...
        <div class="modal-content p-0" style="text-align: center; overflow: hidden;">
            <div class="row" style="width:100%!important; height:100%!important">
                <div class="col s12">
                    <ul class="tabs">
                        <li class="tab col s3"><a class="active" href="#docPrincipalTabFirmado" id="docPrincipalTabFirmadoTrigger">Documento Principal</a></li>
                        <li class="tab col s3"><a href="#docNotificacionTabFirmado" id="docNotificacionTabFirmadoTrigger">Cédula Notificación</a></li>
                    </ul>
                </div>

                <div id="docPrincipalTabFirmado" class="col s12" style="width:100%!important; height:100%!important"></div>
                <div id="docNotificacionTabFirmado" class="col s12" style="width:100%!important; height:100%!important"></div>
            </div>
    ...
    <!-- <div id="modalDocCedulaNotificacion" class="modal modal-fixed-footer modal-fixed-header">
        <div class="modal-header">
            <h4>Cédula de Notificación</h4>
        </div>
        <div class="modal-content p-0" style="text-align: center; overflow: hidden;">
            <iframe frameborder="0" scrolling="auto" style="width:100%!important; height:100%!important"></iframe>
        </div>
        <div class="modal-footer">
            ...
            <a class="waves-effect waves-green btn-flat btn-primary" id="btnFirmarCedulaNotificacion">Firmar</a>
        </div>
    </div> -->
    ...
    <div id="modalPrevisualizacion" class="modal modal-fixed-footer modal-fixed-header">
        <div class="modal-header">
            <div class="row">
                ...
                <div class="col s6" style="text-align: right">
                    Documento 
                    <span id="textActualPre"></span> de 
                    <span id="textTotalPre"></span>
                    <a class="btn btn-link" id="btnAnteriorPre"><i class="fas fa-chevron-left"></i></a>
                    <a class="btn btn-link" id="btnSiguientePre"><i class="fas fa-chevron-right"></i></a> 
                </div> 
            </div>                       
        </div>
        <div class="modal-content p-0" style="text-align: center; overflow: hidden;">
    ...
    <!-- <div id="modalPrevisualizacionNotificacion" class="modal modal-fixed-footer modal-fixed-header">
        <div class="modal-header">
            <h4>Cédula de Notificación</h4>
        </div>
        <div class="modal-content p-0" style="text-align: center; overflow: hidden;">
        ...
        <div class="modal-content">
            ...
            <form name="formEnvioDevolver" class="row">
                <div class="input-field col s12">
                    <select id="codOficinaDevolver"></select>
                    <label for="codOficinaDevolver">Oficina</label>
                </div>
                <div class="input-field col s12">
                    <select id="codEspecialistaDevolver"></select>
    ...
    <!-- <div id="modalDespacho" class="modal modal-fixed-header modal-fixed-footer">
        ...
        <div class="modal-content">
            <form name="formDatosDespacho" id="formDatosDespacho" >
                <input type="hidden" name="IdPersonaExterna" id="IdPersonaExterna" value="0">
                <input type="hidden" name="IdEntidadDespacho" id="IdEntidadDespacho" value="0">
                <input type="hidden" name="IdProyectoDespacho" id="IdProyectoDespacho" value="0">
                <input type="hidden" name="DespachoFlgRequiereDireccion" id="DespachoFlgRequiereDireccion" value="1">
                <div class="row">
                    <div class="col s12">
                        <div class="row">
                ...
                success: function (response) { 
                    $.post("invoker/save.php",
                        ...
                        $.post("enviarDocAsistentes.php",
                            ...
                            let dataFila = {};
                            dataFila.iCodProyectoRef = $("#idTraP").val();
                            dataFila.nFlgTipoDoc = $("#idTipoTra").val();

                            VerDocumentoTabla(idtra,dataFila,true);
                            // $('#modalDocFirmado div.modal-content #docNotificacionTabFirmado').hide();
                            // $('#modalDocFirmado div.modal-content #docNotificacionTabFirmadoTrigger').closest("li").hide();
                            
                            // $('#modalDocFirmado div.modal-content #docPrincipalTabFirmado').html('<iframe src="' + getPreIframe() + data.url + '" frameborder="0" scrolling="auto" style="width:100%!important; height:100%!important"></iframe>');
                            // let elem = document.querySelector('#modalDocFirmado');
                            // let instance = M.Modal.init(elem, {dismissible:false});
                            // instance.open();  
                            
                            // $("#flgFirmaDocPrincipal").val('1');
                            // $("#flgFirmaCedulaNotificacion").val('1');
                            // $("#idTramiteNotificacion").val('');
                            // $("#flgNotificacion").val('');
                            // $("#iCodDocPrincipal").val('');
                        });

                        // $('#modalDocFirmado div.modal-content #docNotificacionTabFirmado').show();
                        // $('#modalDocFirmado div.modal-content #docNotificacionTabFirmadoTrigger').closest("li").show();                        

                        // if($("#idTramiteNotificacion").val() == ''){
                            
                        // } else {
                        //     if($("#flgNotificacion").val() == '' && $("#flgFirmaCedulaNotificacion").val() == 0){
                        //         $.confirm({
                        //             title: 'Documento firmado correctamente, ¿Desea firma la cédula de notificación?',
                        //             content: 'Este proceso es necesario para la notificación en la casilla electrónica del documento.',
                        //             buttons: {
                        //                 Cancelar: function () {
                        //                     tblDocumentos.clear().draw();
                        //                     tblDocumentos.ajax.reload();
                        ...
                        //             method: "POST",
                        //             data: {
                        //                 codigo: $("#iCodDocPrincipal").val()
                        //             },
                        //             datatype: "json",
                        //             success: function (response) {
                        //                 let json = $.parseJSON(response);
                        //                 $('#modalDocFirmado div.modal-content #docPrincipalTabFirmado').html('<iframe src="' + getPreIframe() + json['url'] + '" frameborder="0" scrolling="auto" style="width:100%!important; height:100%!important"></iframe>');
                        //             },
                        //             error: function (e) {
                        //                 console.log(e);
                        ...
                        //             method: "POST",
                        //             data: {
                        //                 codigo: $("#idTramiteNotificacion").val()
                        //             },
                        //             datatype: "json",
                        //             success: function (response) {
                        //                 let json = $.parseJSON(response);
                        //                 $('#modalDocFirmado div.modal-content #docNotificacionTabFirmado').html('<iframe src="' + getPreIframe() + json['url'] + '" frameborder="0" scrolling="auto" style="width:100%!important; height:100%!important"></iframe>');                                    },
                        //             error: function (e) {
                        //                 console.log(e);
                        //                 console.log('Error al obtener el documento!');
                        //                 M.toast({html: "Error al obtener el documento"});
    ...
    <script>
        ...
        $('#nombreDestinoEntidadMRE').on('select2:select', function (e) {
            ContenidosTipo('IdTipoEnvio','12',20,[19,21,72,98]);
            $('#IdTipoEnvio').trigger('change');
        });

        function ObtenerDatosEntidad(id,callfunct,callfunct2 = null) {
            $.ajax({
                cache: false,
                url: "mantenimiento/Entidad.php",
                method: "POST",
        ...
        function ActualizarDatos(datos) {
            ...
            $("#flgRequiereDireccion").val(datos.FlgRequiereDireccion);
            RequiereDireccion(ValidarRequiereDireccion());

            if($('#IdTipoEnvio').val() === '72'){
                if($("select[data-tipo=dependencia]").length > 0){
                    $("#UnidadOrganicaDstIOT").val($("#dependenciaEntidad" + $("select[data-tipo=dependencia]").length + " option:selected").text()).next().addClass('active');
                }

                $("#PersonaDstIOT").val($("#responsableDestinoExterno").val()).next().addClass('active');
                $("#CargoPersonaDstIOT").val($("#cargoResponsableDestinoExterno").val()).next().addClass('active');
            }
        }
        ...
        function AgregarSede(datos) {
            ...
            var arrayUbigeo = [];
            if (datos.nomDepartamento != null && datos.nomDepartamento.trim().length > 0 ){
                if (datos.IdDepartamento.trim() != '15') {
                    arrayUbigeo.push(datos.nomDepartamento.trim());
                }
                if (datos.nomProvincia != null && datos.nomProvincia.trim().length > 0 ){
                    if (!(datos.IdDepartamento.trim() == '15' && datos.IdProvincia.trim() == '01')){
                        arrayUbigeo.push(datos.nomProvincia.trim());
                    }
                    if (datos.nomDistrito != null && datos.nomDistrito.trim().length > 0 ){
                        arrayUbigeo.push(datos.nomDistrito.trim());
                    }                    
                }
            }            
            var ubigeo = arrayUbigeo.join(', ');
        ...
        $('#nombreDestinoExterno').on('select2:select', function (e) {
            ...
            ObtenerDatosEntidad(valor,ActualizarDatos,ValidarTipoDespachoDestinatario);
            ...
            validarCasillaElectronicaEntidadRegistroDoc(valor);            
        });

        function ValidarTipoDespachoDestinatario(dataEntidad){
            
            var rucDespacho = dataEntidad.NumeroDocumento;

            if (rucDespacho == null || rucDespacho == '' || rucDespacho == '0'){
                if(dataEntidad.FlgRequiereDireccion == 1){
                    ContenidosTipo('IdTipoEnvio','12',0,[72,98]);
                    $('#IdTipoEnvio').trigger('change');
                } else {
                    ContenidosTipo('IdTipoEnvio','12',20,[72,19,21,98]);
                    $('#IdTipoEnvio').trigger('change');
                }                            
            } else {                            
                $.ajax({
                    url: RutaSIGTIInteroperabilidad + "ApiInteroperabilidad/Api/Interoperabilidad/Entidad/Entidad_GET_0003?vrucent="+rucDespacho,
                    method: "GET",
                    async: false,
                    ...
                    success: function (data) {
                       /* if (data.MessageResult != '-1'){
                            //INTEROPERABILIDAD
                            $.ajax({
                                url: RutaSIGTIInteroperabilidad + "ApiInteroperabilidad/Api/Interoperabilidad/tramite/SSO_GET_0001",
                                method: "GET",
                                async: false,
                                datatype: "application/json",
                                success: function (datos) {
                                    ...
                                    $.each(datos.ListResult, function (i,value) {
                                        if ($("#cCodTipoDoc option:selected").text().trim().toUpperCase().split(" ")[0] == value.vnomtipdoctraField) {
                                            permite = true;
                                        }
                                    });
                                    //debugger;
                                    if (permite){
                                        if(dataEntidad.FlgRequiereDireccion == 1){
                                            ContenidosTipo('IdTipoEnvio','12',72,[98]);
                                            $('#IdTipoEnvio').trigger('change');
                                        } else {
                                            ContenidosTipo('IdTipoEnvio','12',72,[19,21,98]);
                                            $('#IdTipoEnvio').trigger('change');
                                        }                                                    
                                    } else { 
                                        validarCasillaElectronica(dataEntidad,1);                                                                                                    
                                    }
                                }
                            });
                        } else {
                            validarCasillaElectronica(dataEntidad,2);                                                                                                                  
                        }*/
        ...
        function validarFormulario(){
            var flgResolucion = false;
            if($("#cCodTipoDoc").val() == '39'){
                flgResolucion = true;
            }
            ...
            if($('#cCodTipoTra').val() == '2'){
                if (tblDestinatarios.data().length == 0){
                    $.alert('Falta seleccionar al menos un destinatario!');
                    return false;
                }

                if (tblDestinatarios.data().filter(x => x.cCopia == "0").length == 0){
                    $.alert('Falta seleccionar al menos un destinatario que no sea copia!');
                    return false;
                }                
            } else {
                if (tblDestinosExternos.data().length == 0 && !flgResolucion){
                    $.alert('Falta seleccionar al menos un destinatario!');
                    return false;
                }
            }
        ...
        function listarDestinatarios(id,tipo) {
            $.ajax({
                cache: false,
                method: "POST",
                data: {proyecto: id, tramite: 0, Evento: 'ObtenerDatosDocumentosDestinatarios'},
                url: "registerDoc/Documentos.php",
                datatype: 'json',
                success: function (respuesta) {
                    let data = $.parseJSON(respuesta);
                    ...
                    if(tipo === 2){
                        ...
                        $.each(data,function(index,value){
                            if (value.flgRequiereDireccion == undefined || value.flgRequiereDireccion == null){
                                value.flgRequiereDireccion = 1;
                                value.RequiereDireccion = 'Si';
                            }
    ...
    <script>
        ...
        //tabla de grupos de documentos
            ...
            var tblDocumentos = $('#TblDocumentos').DataTable({
                ...
                ajax: function (data, callback, settings) {
                    ...
                    $.ajax({
                        ...
                        'datatype': 'json',
                        'data': {
                            Evento: "ListarDocumentosUsuario",
                            Agrupado: $("#cDocumentosEnTramite").val()
                        },
                        success: function (response) {
                    ...
                    { 'data': 'datosDespacho', 'autoWidth': true, 'className': 'text-left' },
                    {
                        'render': function (data, type, full, meta) {
                            ...
                            if(full.tipo === 'proyecto'){
                                ...
                                //     if (full.IdTipoDespacho === 98) {
                                //         botones += '<button type="button" data-accion="preVisualizarNotificacion" data-tooltip="Ver Cédula de Notificación" class="btn btn-sm btn-link tooltipped" data-position="bottom" name="Ver Cédula de Notificación"><i class="fas fa-file-import"></i></button>';
                                //     }
                                // }
                            ...
                            if(full.tipo === 'tramite'){
                                ...
                                // if (full.nFlgTipoDoc === 3 && full.idTramiteNotificacion !== 0) {
                                //         botones += '<button type="button" data-accion="verNotificacion" data-tooltip="Ver Cédula de Notificación" class="btn btn-sm btn-link tooltipped" ' + (full.flgFirmaNotificacion == 0 ? 'style="color: #ff8f00"' : '') + ' data-position="bottom" name="Ver Cédula de Notificación"><i class="fas fa-file-import"></i></button>';
                                //     }
            ...
            var listadoPrevisualizacion = [];
            var docActualPrevisualizacion = 0;
            ...
            $('#TblDocumentos tbody').on('click', 'button', function (event) {
                ...
                switch (accion) {
                    case 'editar':
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if(data.nFlgTipoDoc == '3' && (data.cCodTipoDoc == '13' || data.cCodTipoDoc == '41')){
                                ...
                                listarDestinatarios(dataFila.codigo,data.nFlgTipoDoc);
                            ...
                            error: function (e) {
                                ...
                                deleteSpinner();
                                M.toast({html: "Error al obtener los datos"});
                                $(fila.node()).find('button[name="Editar"]').css('display','inline-block');
                                $("#btnValidacionAgregar").css("display","inline-block");
                            }
                        });
                        break;
                    ...
                    case 'pre-visualizacion':
                        ...
                        docActualPrevisualizacion = 0;

                        if(dataFila.nFlgTipoDoc == 2){
                            listadoPrevisualizacion.push({id: dataFila.codigo, destino: 0, notificacion: 0}); 
                            mostrarDocumentoPre(false,false);
                            ...
                            $.ajax({
                                cache: false,
                                method: "POST",
                                data: {proyecto: dataFila.codigo, tramite: 0, Evento: 'ObtenerDatosDocumentosDestinatarios'},
                                url: "registerDoc/Documentos.php",
                                datatype: 'json',
                                success: function (respuesta) {
                                    ...
                                    $.each(respuesta, function(i,e){
                                        listadoPrevisualizacion.push({id: dataFila.codigo, destino: e.iCodRemitente, notificacion: 0});
                                        if(e.idTipoEnvio == 98){
                                            listadoPrevisualizacion.push({id: dataFila.codigo, destino: e.iCodRemitente, notificacion: 1});
                                        }                                        
                                    });
                                    mostrarDocumentoPre(false,false);
                                    let instance = M.Modal.getInstance($("#modalPrevisualizacion"));
                                    ...
                                    action: function() {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function () {
                                                ...
                                                if ((tblDocumentos.data().length - 1) == 0){
                    ...
                    //                 datos = datos[0];
                    //                 $('#formDatosDespacho #IdEntidadDespacho').val(datos.iCodRemitente);
                    ...
                    //                 $('#formDatosDespacho #DespachoFlgRequiereDireccion').val(datos.flgRequiereDireccion);
                    ...
                    //     if (rucDespacho == null || rucDespacho == '' || rucDespacho == '0'){
                    //         if($('#formDatosDespacho #DespachoFlgRequiereDireccion').val() == 1){
                    //             ContenidosTipo('IdTipoEnvio','12',0,[72,98]);
                    //             $('#IdTipoEnvio').trigger('change');
                    //         } else {
                    //             ContenidosTipo('IdTipoEnvio','12',20,[72,19,21,98]);
                    ...
                    //                                 }                                                    
                    //                             } else { 
                    //                                 validarCasillaElectronica($('#formDatosDespacho #IdEntidadDespacho').val(),1);                                                                                                    
                    //                             }
                    //                         }
                    //                     });
                    //                 } else {
                    //                     validarCasillaElectronica($('#formDatosDespacho #IdEntidadDespacho').val(),2);                                                                                                                  
                    //                 }
                    //             }
                    //         });
                    ...
                    case 'generar':
                        $(fila.node()).find('button[name="Generar"]').css('display','none');
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (response) {
                                            ...
                                            if($("#nCud").val() == ''){
                                                ...
                                                dataFila.iCodProyectoRef = dataFila.codigo;
                                                VerDocumentoTabla(json['iCodTramite'],dataFila)
                                        ...
                                        error: function (e) {
                                            ...
                                            $(fila.node()).find('button[name="Generar"]').css('display','inline-block');
                                        }
                                    });
                                },
                                No: function () {
                                    ...
                                    Validar: function(){
                                        ...
                                        if(val.trim() != ''){
                                            $.ajax({
                                                ...
                                                data: {
                                                    codigo: dataFila.codigo,
                                                    codigoP: dataFila.iCodProyectoRef,
                                                    tipo: dataFila.nFlgTipoDoc
                                                },
                                                datatype: "json",
                                                success: function (response) {
                                                    let json = $.parseJSON(response);
                                                    let idDigital = json.data;
                                                    let flgRequireFirmaLote = json.flgRequireFirmaLote;
                                                    let idEntidad = json.idEntidad;
                                                    
                                                    if (json.length !== 0){
                                                        console.log('¡Documento obtenido!');
                                                        $("#idDigital").val(idDigital);
                                                        $("#idtra").val(dataFila.codigo);
                                                        $("#tipo_f").val('v');
                                                        $("#nroVisto").val(dataFila.visto);
                                                        $("#idTraP").val(dataFila.iCodProyectoRef);
                                                        $("#idTipoTra").val(dataFila.nFlgTipoDoc);
                    ...
                    case 'firmar':
                        // $("#iCodDocPrincipal").val(dataFila.codigo);
                        // $("#flgFirmaCedulaNotificacion").val(dataFila.flgFirmaNotificacion);
                                        ...
                                        if(val.trim() != ''){
                                            $.ajax({
                                                ...
                                                success: function (data) {
                                                    ...
                                                    if(datos.validacion){
                                                        VerDocumentoTabla(dataFila.codigo, dataFila);
                                                    } else {
                    ...
                    case 'ver-anexos':
                        ...
                        break;
                    // case 'preVisualizarNotificacion':
                    //     $.ajax({
                    //         url: 'registerDoc/Documentos.php',
                    //         method : 'POST',
                    //         datatype: 'json',
                    ...
                    //             let datos = $.parseJSON(response);
                    //             $.ajax({
                    //                 url: "previsualizacion-notificacion-pdf.php",
                    //                 method: "POST",
                    //                 dataType : "text",
                    ...
                    //                 success: function (respuesta) {
                    //                     let datos = respuesta;
                    //                     let ifr = $("#modalPrevisualizacionNotificacion iframe");
                    //                     ifr.attr('src','data:application/pdf;base64,' + datos);
                    //                     let instance = M.Modal.getInstance($("#modalPrevisualizacionNotificacion"));
                    //                     instance.open();
                    //                 },
                    //                 error: function (e) {
                    //                     console.log(e);
                    ...
                    //     $("#iCodDocPrincipal").val(dataFila.codigo);
                    //     $("#flgFirmaDocPrincipal").val(dataFila.firma);
                    //     $('#modalDocCedulaNotificacion').modal('close');
                    //     $.ajax({
                    //         url: "ajax/obtenerDoc.php",
                    //         method: "POST",
                    //             data: {
                    //                 codigo: dataFila.idTramiteNotificacion
                    //             },
                    //             datatype: "json",
                    //                     success: function (response) {
                    //                         let json = $.parseJSON(response);
                    ...
                    //                             if(dataFila.flgFirmaNotificacion){
                    //                                 $('#btnFirmarCedulaNotificacion').hide();
                    //                             } else {
                    //                                 $("#idTramiteNotificacion").val(dataFila.idTramiteNotificacion);
                    //                             }                                                
                                                
                    //                             // TODO: Revisar
                    //                             $('#modalDocCedulaNotificacion div.modal-content').html('');
                    //                             $('#modalDocCedulaNotificacion div.modal-content').html('<iframe src="' + getPreIframe() + json['url'] + '" frameborder="0" scrolling="auto" style="width:100%!important; height:100%!important"></iframe>');
                    //                             $('#modalDocCedulaNotificacion').modal('open');
                    //                         } else {
                    //                             console.log('¡No se pudo obtener el documento!');
                    //                             M.toast({html:'¡No se pudo obtener el documento!'});
                    //                         }
            ...
            function mostrarDocumentoPre(anterior,siguiente){
                $("#btnAnteriorPre").removeAttr("disabled");
                $("#btnSiguientePre").removeAttr("disabled");

                if(anterior){
                    docActualPrevisualizacion--;
                }
                ...
                if(docActualPrevisualizacion == 0){
                    $("#btnAnteriorPre").attr('disabled', 'disabled');
                }

                if(docActualPrevisualizacion + 1 == listadoPrevisualizacion.length){
                    $("#btnSiguientePre").attr('disabled', 'disabled');
                }

                $("#textActualPre").text(docActualPrevisualizacion + 1);
                $("#textTotalPre").text(listadoPrevisualizacion.length);

                let seleccionado = listadoPrevisualizacion[docActualPrevisualizacion];
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        datos.id = seleccionado.id;

                        let ruta = 'previsualizacion-pdf.php';
                        if(seleccionado.notificacion == 1){
            ...
            $("#btnAnteriorPre").on("click", function(e){
                mostrarDocumentoPre(true,false);
            });

            $("#btnSiguientePre").on("click", function(e){
                mostrarDocumentoPre(false,true);
            });

            // $("#btnFirmarCedulaNotificacion").on("click", function(e){
            //     e.preventDefault();
            //     e.stopPropagation();
            //     FirmarDocumentoNotificacion();
            // });

            function validarCasillaElectronica(entidad, tipo){
                // if($('#formDatosDespacho #DespachoFlgRequiereDireccion').val() == 1){
                //     ContenidosTipo('IdTipoEnvio','12',0,[72,98]);
                //     $('#IdTipoEnvio').trigger('change');
                // } else {
                ...
                //     $('#IdTipoEnvio').trigger('change');
                // } 
                $.post("mantenimiento/Entidad.php", {"Evento": "ObternerDatos", "idEntidad": entidad.IdEntidad})
                    .then(function(data){
                        data = JSON.parse(data);
                        ...
                        $.get(`${RutaServiciosCasilla}/mpi/validar-usuario-casilla?TipoDoc=${tipoDoc}&NroDocumento=${data.NumeroDocumento}`)
                            .then(function(resultado){
                                if (tipo == 1){
                                    if(resultado.code == 200 && resultado.result != null){
                                        ContenidosTipo('IdTipoEnvio','12',98,[72,19,21,20]);
                                        $('#IdTipoEnvio').trigger('change');
                                        $("#IdPersonaExterna").val(resultado.result.iD_USUARIO_SSO);
                                    } else {
                                        if(entidad.FlgRequiereDireccion == 1){
                                            ContenidosTipo('IdTipoEnvio','12',0,[72,98]);
                                            $('#IdTipoEnvio').trigger('change');
                                        } else {
                                            ContenidosTipo('IdTipoEnvio','12',20,[72,19,21,98]);
            ...
            function validarCasillaElectronicaEntidadRegistroDoc(idEntidad){
                $("#avisoCasillaElectronica").hide();
                $("#avisoCasillaElectronica span").text("");
                $.post("mantenimiento/Entidad.php", {"Evento": "ObternerDatos", "idEntidad": idEntidad})
                    .then(function(data){
                        data = JSON.parse(data);                        
                        if(data.NumeroDocumento !="" && data.NumeroDocumento != null ){
                            var tipoDoc = 0;
                            switch(data.IdTipoDocumento){
                                case 73:
                                    tipoDoc = 1;
                            ...
                            .then(function(resultado){
                                if(resultado.code == 200 && resultado.result != null){
                                    $("#avisoCasillaElectronica").show();
                                    $("#avisoCasillaElectronica strong span").text(resultado.result.usuario);
                                }                                
                            })
                        }                        
                    })
            ...
            function CargaDocumentosGrupo (){
                ...
                let agrupadoInicial = $("#cAgrupado").val();

                if (agrupado == "0" && agrupadoInicial == "0") {
                    $("#btnDerivar").hide();
                    $("#btnDevolver").hide();
                    $("#btnArchivar").hide();
                    // $("#btnRetroceder").hide();
                ...
                if (tblDocumentos.page.info().recordsTotal > 0) {
                    ListarReferenciaAgrupado(agrupado);
                    ListarAnexosAgrupado(agrupado);
                } else {
                    if ($("input[name=tramitesRspt]").length > 0 && $("input[name=tramitesRspt]").val() != ''){
                        let tramites = $("input[name=tramitesRspt]").val();
                        listarReferencias(tramites);
                        $.each(JSON.parse(tramites), function (i,val) {
        ...
        function VerDocumentoTabla(id, datos = null, firmado = false){
            if(firmado){
                $("#btnCerrarDocFirmado").show();
                $("#btnCerrarNormal").hide();
            } else {
                $("#btnCerrarNormal").show();
                $("#btnCerrarDocFirmado").hide();
            }
            ...
            if(datos == null){
                listadoVer.push({id: id, destino: 0, notificacion: 0}); 
                mostrarDocumentoVer(false,false);
                let instance = M.Modal.getInstance($("#modalDoc"));
                instance.open();
            } else { 
                if(datos.nFlgTipoDoc == 2 || datos.nFlgTipoDoc == 1){
                    listadoVer.push({id: id, destino: 0, notificacion: 0}); 
                    mostrarDocumentoVer(false,false);
                    let instance = M.Modal.getInstance($("#modalDoc"));
                    instance.open();
                    ...
                    $.ajax({
                        cache: false,
                        method: "POST",
                        data: {proyecto: datos.iCodProyectoRef, tramite: 0, Evento: 'ObtenerDatosDocumentosDestinatarios'},
                        url: "registerDoc/Documentos.php",
                        datatype: 'json',
                        success: function (respuesta) {
                            respuesta = $.parseJSON(respuesta);
                            ...
                            $.each(respuesta, function(i,e){
                                listadoVer.push({id: id, destino: e.iCodRemitente, notificacion: 0});
                                if(e.idTipoEnvio == 98){
                                    listadoVer.push({id: e.idTramiteNotificacion, destino: e.iCodRemitente, notificacion: 1});
                                }                                        
                            });
                            mostrarDocumentoVer(false,false);
                            let instance = M.Modal.getInstance($("#modalDoc"));
        ...
        function mostrarDocumentoVer(anterior,siguiente){
            $("#btnAnteriorVer").removeAttr("disabled");
            $("#btnSiguienteVer").removeAttr("disabled");
            ...
            if(docActualVer == 0){
                $("#btnAnteriorVer").attr('disabled', 'disabled');
            }

            if(docActualVer + 1 == listadoVer.length){
                $("#btnSiguienteVer").attr('disabled', 'disabled');
            }

            $("#textActualVer").text(docActualVer + 1);
            $("#textTotalVer").text(listadoVer.length);

            let seleccionado = listadoVer[docActualVer];
        ...
        $("#btnAnteriorVer").on("click", function(e){
            mostrarDocumentoVer(true,false);
        });

        $("#btnSiguienteVer").on("click", function(e){
            mostrarDocumentoVer(false,true);
        });
        ...
        //             }
        //         } else if ($("#IdTipoEnvio").val() == 98) {
        //             if ($("#FoliosDespacho").val().trim() == '' || $("#FoliosDespacho").val() == 0){
        //                 estado = false;
        //                 $.alert("Falta ingresar la cantidad total de folios");
        //             }
        //         }
        //     } else {
        //         estado = false;
        ...
        var tblDestinatarios = $('#TblDestinatarios').DataTable({
            ...
            'columns': [
                ...
                {
                    'render': function (data, type, full, meta) {
                        return `<button type="button" data-id="${full.id}" data-accion="eliminar" data-toggle="tooltip" title="Eliminar" class="btn btn-sm btn-link tooltipped" data-placement="top"><i class="fas fa-trash-alt"></i></button>`;
        ...
        $("#TblDestinatarios tbody").on('click', 'button', function () {
            ...
            if(accion === 'eliminar'){
                if(id != 0){
                    getSpinner('Eliminando destinatario');
                    $.ajax({
                        url: "registerDoc/Documentos.php",
                        method: "POST",
                        data: {
                            Evento: 'EliminarDestinatario',
                            id: id
                        },
                        datatype: "json",
                        success: function () {
                        ...
                        error: function (e) {
                            console.log(e);
                            console.log('Error al eliminar el destinatario!');
                            deleteSpinner();
                            M.toast({html: "Error al eliminar el destinatario"});
                        }
                    });
                }
        ...
        $("#btnAgregarDestinatario").click(function(){
            ...
            if($('#flgDelegar').is(':checked')){
                if ($("#responsableE").val() == null || $("#responsableE").val() == "" || $("#responsableE").val() == 0){
                ...
                if ($("#iCodOficinaO").val() == ""){
                    ...
                    return false
                } else if ($("#codResponsableiO").val() == null || $("#codResponsableiO").val() == "" || $("#codResponsableiO").val() == 0){
                    $.alert('Falta seleccionar responsable');
                    return false
                } else {
        ...
        var tblDestinosExternos = $('#TblDestinosExternos').DataTable({
            ...
            'columns': [
                {   "width": "20%", 'className': 'text-left',
                    'render': function (data, type, full, meta) {
                        var html = '';
                        if(full.nroDocumento != null){
                            html += `<small><b>${full.nroDocumento}</b></small><br/>`;
                        }

                        html += `${full.nomRemitente}<br/>
                                <small><i>Requiere Dirección: <b>${full.RequiereDireccion}</b></i></small>`
                ...
                // { 'data': 'RequiereDireccion', 'autoWidth': true, "width": "5%",'className': 'text-left' },
                // { 'data': 'cDireccion', 'autoWidth': true, "width": "10%",'className': 'text-left' },
                {   "width": "20%", 'className': 'text-left',
                    'render': function (data, type, full, meta) {
                        if(full.cDireccion != '' && full.cDireccion != null){
                            return `${full.cDireccion}<br/>
                                    <small><i>Mostrar: <b>${full.mostrarDireccion}</b></i></small>`;
                        } else {
                            return '';
                        }
                    }
                ...
                {   "width": "20%", 'className': 'text-left',
                    'render': function (data, type, full, meta) {
                        return `<small><b>${full.preFijo}</b></small><br/>
                                ${full.nombreResponsable}<br/>
                                <small><i>${full.cargoResponsable}</i></small>`;
                    }
                },
                { 'data': 'nombreTipoEnvio', 'autoWidth': true, "width": "10%",'className': 'text-center' },
                { 'data': 'observacionesDespacho', 'autoWidth': true, "width": "20%",'className': 'text-left' },
                ...
                // { 'data': 'cargoResponsable', 'autoWidth': true, "width": "50%",'className': 'text-left' },
                // { 'data': 'mostrarDireccion', 'autoWidth': true, "width": "5%",'className': 'text-left' },
                {
                    'render': function (data, type, full, meta) {
                        return `<button type="button" data-id="${full.id}" data-accion="eliminar" data-toggle="tooltip" title="Eliminar" class="btn btn-sm btn-link tooltipped" data-placement="top"><i class="fas fa-fw fa-trash-alt"></i></button>`;
                    }, 'className': 'center-align',"width": "10%"
                },
            ]
        });
        ...
        $("#btnAgregarDestinoExterno").click(function(){
            ...
            if($("#cCodTipoTra").val() == '3' && ($("#cCodTipoDoc").val() == '13' || $("#cCodTipoDoc").val() == '41')){
                ...
                destino.flgRequiereDireccion = 0;
                destino.RequiereDireccion = 'No';
                destino.cDireccion = "";
                destino.IdSede = "";

                destino.nroDocumento = '';            
                destino.preFijo = '';
                destino.nombreResponsable= '';
                destino.cargoResponsable= '';
            } else {
                ...
                if (ValidarRequiereDireccion() && ($("#direccionDestinoExterno").val() == '' || $("#direccionDestinoExterno").val() == null)){
                ...
                if (ValidarRequiereDireccion()){
                    destino.flgRequiereDireccion = 1;
                    destino.RequiereDireccion = 'Si';
                } else {                
                    destino.flgRequiereDireccion = 0;
                    destino.RequiereDireccion = 'No';
                    destino.cDireccion = "";
            ...
            if ($("#IdTipoEnvio").val() != 0) {
                if ($("#IdTipoEnvio").val() == 19 || $("#IdTipoEnvio").val() == 21){
                    if ($("#direccionDestinoExterno").val() == '' || $("#direccionDestinoExterno").val() == null){
                        return $.alert("Falta dirección del despacho");
                    }
                } else if ($("#IdTipoEnvio").val() == 72){
                    if ($("#UnidadOrganicaDstIOT").val().trim() == ''){
                        return $.alert("Falta unidad orgánica destino");
                    } else if ($("#PersonaDstIOT").val().trim() == '') {
                        return $.alert("Falta persona destino")
                    } else if ($("#CargoPersonaDstIOT").val().trim() == '') {
                        return $.alert("Falta cargo de persona destino")
                    }

                    destino.unidadOrganicaDstIOT = $("#UnidadOrganicaDstIOT").val().trim();
                    destino.personaDstIOT = $("#PersonaDstIOT").val().trim();
                    destino.cargoPersonaDstIOT = $("#CargoPersonaDstIOT").val().trim();
                } else if ($("#IdTipoEnvio").val() == 19) {
                    if ($("#ObservacionesDespacho").val().trim() == ''){
                        return $.alert("Falta observación");
                    }
                } else if ($("#IdTipoEnvio").val() == 98) {
                    if ($("#FoliosDespacho").val().trim() == '' || $("#FoliosDespacho").val() == 0){
                        return $.alert("Falta ingresar la cantidad total de folios");
                    }

                    destino.foliosDespacho = $("#FoliosDespacho").val().trim();
                    destino.idPersonaExterna = $("#IdPersonaExterna").val().trim();
                }
            } else {
                return $.alert("Falta seleccionar el tipo de despacho");
            }

            destino.idTipoEnvio = $("#IdTipoEnvio").val();
            destino.nombreTipoEnvio = $("#IdTipoEnvio option:selected").text();
            
            destino.observacionesDespacho = $("#ObservacionesDespacho").val().trim();            

            //VALIDAR SI YA ESTA INGRESADO
            let data = tblDestinosExternos.data();
            let estado = false;
            $.each(data, function (i, item) {
                if (destino.iCodRemitente == item.iCodRemitente) {
                    estado = true;
                }
            });
            if (!estado) {
                ...
                // let newOption = new Option("Seleccione y busque", null, false, false);
                // $('#nombreDestinoExterno').empty().append(newOption).trigger('change').trigger('select2:select');
                // $('#nombreDestinoEntidadMRE').empty().append(newOption).trigger('change').trigger('select2:select');

                ContenidosTipo('IdTipoEnvio','12',20,[72,19,20,21,98]);

                $("#UnidadOrganicaDstIOT").val("");
                $("#PersonaDstIOT").val("");
                $("#CargoPersonaDstIOT").val("");
                $("#ObservacionesDespacho").val("");
                $("#FoliosDespacho").val("");

            } else {
                $.alert("El destinatario ya fue ingresado");
            }
        });
        ...
        function obtenerDatosFormulario () {
            ...
            if ($('#cCodTipoTra').val() == '2'){
               ...
               var tabla = tblDestinatarios.data().toArray().concat(tblDestinosExternos.data().toArray());
            }
        ...
        $("#dropzoneAgrupado").dropzone({
            ...
            maxFiles: 10,
            acceptedFiles: ".jpg, .jpeg, .png, .pdf, .doc, .docx, .xls,.xlsx, .ppt, .pptx, .rar, .zip, .7z",
            addRemoveLinks: true,
            maxFilesize: 1200, // MB
            uploadMultiple: true,
            parallelUploads: 10,
                ...
                $("#btnGuardarCambios").on('click',function (e) {
                    ...
                    if(validarFormulario()){
                        ...
                        if (queuedFiles.length > 0) {
                            ...
                            let datos = obtenerDatosFormulario();
                            datos.delete("Evento","registrarProyecto");
                            datos.append("Evento","GuardarDatos");
                            datos.append("cObservaciones","");
                            getSpinner('Guardando documento');
                ...
                if (sesionPerfil == 18 || sesionPerfil == 19 || sesionPerfil == 20) {
                    ...
                    if (filas.iCodOficinaFirmante == sesionOficina && filas.iCodTrabajadorFirmante == sesionTrabajador) {
                        if (filas.tipo == 'proyecto'){
                            ...
                            // else if ((filas.idTramiteNotificacion != null && filas.idTramiteNotificacion != 0) && filas.flgFirmaNotificacion == 0) {
                            //     $.alert('No se puede derivar, tiene una cédula de notificación pendiente de firma');
                            //     $(x).removeClass("disabled");
                            //     salir += 1;
                            // } 
                            /*else {
        ...
        function RedirigirBandeja(){
            if(sesionPerfil == 3){
                $.post("ajaxtablas/ajaxBpAprobar.php").done(function (x){
                    var x = $.parseJSON(x);
                    if (x.data.length > 0){
                        // setTimeout(function(){ window.location = "bandeja-por-aprobar.php"; });
                        window.location = "bandeja-por-aprobar.php"; 
                    } else {
                        // setTimeout(function(){ window.location = "bandeja-de-pendientes.php"; });
                        window.location = "bandeja-de-pendientes.php";
                    }
                });
            } else {
                // setTimeout(function(){ window.location = "registroOficina.php"; });
                window.location = "registroOficina.php";
            } 
        }  
        ...
        $("#cCodTipoDoc").on("change", function (e) {
            ...
            if($("#cCodTipoTra").val() == '3' && $("#cCodTipoDoc").val() == '39'){                
                $("#nombreDestinoEntidadMREcol").css("display","block");
                $("#opcionalFields").css("display","none");
                $("#destinoExterno").css("display","none");
                //$("#destinatario").css("display","none"); 
            } else if($("#cCodTipoTra").val() == '3' && ($("#cCodTipoDoc").val() == '13' || $("#cCodTipoDoc").val() == '41')){
                $("#nombreDestinoExternocol").css("display","none");
                $("#nombreDestinoEntidadMREcol").css("display","block");
                $("#opcionalFields").css("display","none");
                //$("#destinatario").css("display","none"); 
                
            } else if($("#cCodTipoTra").val() == '3'){
        ...
        function tiposDocumentos(codDoc,selecionado = ''){
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#cCodTipoDoc').formSelect().trigger("change");
                }
            });
        }
        ...
        $("#btnEnviarArchivar").on('click', function(e) {
            ...
            var cAgrupado = $("#cDocumentosEnTramite").val() == '0' ? $("#cAgrupado").val() : $("#cDocumentosEnTramite").val();

            parametros = {
                iCodAgrupado: cAgrupado,
        ...
        $("#btnCerrarDocFirmado").on("click", function (e) {
            // $(this).css('display','none');
            $("#btnCerrarDocFirmado").css('display','none');
            $("#btnCerrarDocFirmado").addClass('disabled');
            e.preventDefault();
            ...
            // if($("#flgFirmaDocPrincipal").val() == 1 && $("#flgFirmaCedulaNotificacion").val() == 1){            
            //     $.confirm({
            //         title: '¿Desea derivar o continuar trabajando?',
            //         content: '',
            //         buttons: {
        ...
        $('#IdTipoEnvio').on('change', function (e) {
            ...
            $("#datosEnvioInteroperabilidad input").val("");
            
            $('#datosCasilla').css('display','none');
            ...
            if ($('#IdTipoEnvio').val() === '19' || $('#IdTipoEnvio').val() === '21') {
                ...
                $('#datosEnvioFisico').css('display','none');
                $('#datosEnvioInteroperabilidad').css('display','none');
                $('#datosCasilla').css('display','block');
            }
        });
        ...
        function ListarOficinaDevolver() {
            $.ajax({
                cache: false,
                url: "ajax/ajaxOficinaDevolver.php",
                method: "POST",
                datatype: "json",
                success: function (data) {
                    data = JSON.parse(data);
                    $('#codOficinaDevolver').empty();
                    // .append('<option value="">Seleccione Oficina</option>');
                    $.each(data, function(key, value) {
                        $('#codOficinaDevolver').append('<option value="'+value.iCodOficina+'">'+value.nomOficina+'</option>');
                    });
                    $('#codOficinaDevolver').formSelect().trigger('change');
                }
            });
        }
        ...
        $("#flujo").on("click",function(e){
            ...
            if($("#nCud").length != 0){
                ...
                var movimientos = [];
                if ($("input[name=iCodMov]").length != 0){
                    movimientos.push($("input[name=iCodMov]").val());
                }                
                $.ajax({
                    cache: false,
                    url: documentophp,
                    method: "POST",
                    data: {"cud" : $("#nCud").val(), "iCodMovimiento" : movimientos},
                    datatype: "json",
                    success : function(response) {
        ...
        $("#dropzoneAgrupadoArchivar").dropzone({
                ...
                autoProcessQueue: false,
                maxFiles: 10,
                acceptedFiles: ".jpg, .jpeg, .png, .pdf, .doc, .docx, .xls,.xlsx, .ppt, .pptx, .zip, .rar, .7z",
                addRemoveLinks: true,
                maxFilesize: 1200, // MB
                uploadMultiple: true,
                parallelUploads: 10,
        ...
        function ValidarRequiereDireccion(){
            if($("#flgRequiereDireccion").val() == 0 && $("#cCodTipoTra").val() == 3 && $("#cCodTipoDoc").val() == 17){
                return false;
            }
            return true;
        }
        ...
        function RequiereDireccion(requiere) {
            if(!requiere){
                $("#direccionDestinoExterno").closest("div.input-field").css("display", "none");
                $("#flgMostrarDireccion").prop("checked",true);
                $("#flgMostrarDireccion").closest("div.switch").css("display","none")
            } else {
                $("#direccionDestinoExterno").closest("div.input-field").css("display", "flex");
                $("#flgMostrarDireccion").prop("checked",false);
                $("#flgMostrarDireccion").closest("div.switch").css("display","block")
            }
        }

        // function FirmarDocumentoNotificacion(){
        //     $('#modalDocCedulaNotificacion').modal('close');

        //     var codigoF = $("#idTramiteNotificacion").val();
        //     $.ajax({
        //         url: "ajax/obtenerDocFirma.php",
        //         method: "POST",
        //         data: {
        ...
        //             if (json.length !== 0){
        //                 $("#idDigital").val(json['idDigital']);
        //                 $("#idtra").val(codigoF);
        //                 $("#tipo_f").val('f');
        //                 $("#nroVisto").val(0);
        //                 $("#datosDoc").val('');
        //                 $("#flgNotificacion").val(1);
