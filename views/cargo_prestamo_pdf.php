...
$titulo = 'CARGO DE SERVICIO ARCHIVISTICO N° '.$datosSolicitud['NroCargoPrestamo'];
...
$nuevo_nombre = "cargo-prestamo-".str_replace("/","-", $datosSolicitud['NroCargoPrestamo']).'.pdf';
