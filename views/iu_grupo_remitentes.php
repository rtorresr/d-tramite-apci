...
<div class="AreaTitulo">Mantenimiento >> M. Grupo Remitentes</div>


<form name="form1" method="GET" action="iu_grupo_remitentes.php">
<table width="800" border="0" align="center">
  <tr>
    <td>
     ...
     <tr>
    <td width="375" height="42"  >Grupo de Remitente:</td>
...
$sql= "SP_GRUPO_REMITENTES_LISTA '%$_GET[cGrupo]%' ,'".$orden."' , '".$campo."' ";
/*
...
?>
<tr>
  <td width="400" class="headCellColum"><a style=" text-decoration:<?php if($campo=="Grupo"){ echo "underline"; }Else{ echo "none";}?>" href="<?=$_SERVER['PHP_SELF']?>?campo=Grupo&orden=<?=$cambio?>&cGrupo=<?=$_GET[cGrupo]?>">Grupo de Remitentes</a></td>
...
<tr bgcolor="<?=$color?>">
    <td align="left" >
      <a href="/iu_grupo_remitentes_detalle.php?cod=<?=$Rs[iCodGrupo]?>&sw=13"><?php echo $Rs[cDesGrupo]."(".$Rs[Cantidad].")";?></a>
    </td>
    <td>
  <? 
      if($Rs[cFlgAdmin]==0){ ?>
      <a href="../controllers/ln_elimina_grupo_remitente.php?id=<?php echo $Rs[iCodGrupo];?>" onClick='return ConfirmarBorrado();'"><img src="images/icon_del.png" width="16" height="16" alt="Eliminar Grupo de Destinos" border="0"></a>
     <?php }
    if($Rs[cFlgAdmin]==1){  ?>
    <img src="images/icon_del_off.png" width="16" height="16" alt="Grupo de Destinos" border="0">
  <?  } 
    if($Rs[cFlgAdmin]==0){ ?>
    <a href="/iu_actualiza_grupo_remitentes.php?cod=<?php echo $Rs[iCodGrupo];?>&sw=13"><img src="images/icon_edit.png" width="16" height="16" alt="Editar Grupo de Destinos" border="0"></a>
  <?  } 
    if($_SESSION['iCodPerfilLogin']==1){
    if($Rs[cFlgAdmin]==0){ ?>
    <a href="../controllers/ln_est_grupo_remitente.php?cod=<?php echo $Rs[iCodGrupo];?>&op=1"><img src="images/icon_aceptar.png" width="16" height="16" alt="Editar Grupo de Destinos" border="0"></a></td>
  <?  } 
    if($Rs[cFlgAdmin]==1){ ?>
    <a href="../controllers/ln_est_grupo_remitente.php?cod=<?php echo $Rs[iCodGrupo];?>&op=2"><img src="images/icon_clear.png" width="16" height="16" alt="Editar Grupo de Destinos" border="0"></a></td>
  <?  } 
    }?>
  </tr>
...
<?php echo paginar($pag, $total, $tampag, "iu_grupo_remitentes.php?pag=");?>
<table width="240" border="0" align="center">
  <tr>
    <td align="right"><?echo "<a class='btn btn-primary' href='iu_nuevo_grupo_remitentes.php'>Nuevo Grupo</a>";
?>
</td>
  </tr>
</table>
