      	...
      	<input type="hidden" name="Jefe" value="<?=$_SESSION['JEFE']?>">
									...
									<option value="">Seleccione:</option>
										<?php
											$sqlTipo = "SELECT * FROM Tra_M_Tipo_Documento 
																	WHERE nFlgInterno = 1 AND cCodTipoDoc != 45 
			...
			<tr>
				...
				<td valign="top">
					...
					<td align="center"></td>
					<td align="center"><div class="btn btn-primary" style="width:125px;height:17px;padding-top:4px;"><a style=" text-decoration:none" href="javascript:;" onClick="Buscar();">Añadir Referencia</a> </div></td>
					</tr></table>
                    ...
                    <option value="">Seleccione:</option>
                        <?php
                            ...
                            while ($RsTipo = sqlsrv_fetch_array($rsTipo)){
                                ...
                                echo "<option value=".$RsTipo["iCodTrabajador"]." ".$selecTipo.">".$RsTipo["cApellidosTrabajador"].", ".$RsTipo["cNombresTrabajador"]."</option>";
                            }
                            sqlsrv_free_stmt($rsTipo);
                    ?>
                </select>
