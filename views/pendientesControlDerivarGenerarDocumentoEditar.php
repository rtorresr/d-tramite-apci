			...
			<tr>
      				...
      				<table cellpadding="3" cellspacing="3" border="0" >	
                        <tr>
							...
							<td align="left" class="CellFormRegOnly">
								<select name="iCodOficinaDerivar" style="width:400px;" class="FormPropertReg form-control" disabled>
								<?php				
						...
						<tr>
							<td >Responsable:</td>
							<td align="left" class="CellFormRegOnly">
								<select name="iCodTrabajadorDerivar" style="width:250px;" class="FormPropertReg form-control" disabled>
								<?php
						...
						<tr>
							...
							<td align="left" class="CellFormRegOnly">
								<select name="iCodIndicacionDerivar" style="width:200px;" class="FormPropertReg form-control" disabled>
									<?php
                ...
                <fieldset>
                		<table>
							...
							<tr>
								...
								<td align="left"><textarea name="cAsuntoDerivar" style="width:250px;height:55px" class="FormPropertReg form-control"><?php echo $RsDoc->cAsuntoDerivar;?></textarea></td>
							...
							<td align="left">
								...
								<tr>
				          			<td align="center">
				          				...
				          				<!--a style=" text-decoration:none" href="#" title="Lista de Oficinas" rev="width: 500px; height: 550px; scrolling: auto; border:no">Seleccione Oficinas</a--></div>
				          			</td>
				         	 	</tr>
				          		</table>
				...
				<table width="100%">
					<tr>
							...
							<input type="hidden" name="documentoElectronicoPDF" id="documentoElectronicoPDF">
						...
						<tr>
							<td colspan="4">
								 <input name="button" type="button" class="btn btn-primary" style="font-size: 12px;height: 29px;width: 100px;" value="Finalizar" onclick="subir_documento_electronico_firmado();">
						  	<td>
						</tr>
				</table>			
