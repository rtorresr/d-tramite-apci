<?
/**************************************************************************************
NOMBRE DEL PROGRAMA: iu_correlativo_interno.php
...
<div class="AreaTitulo">Mantenimiento >> M. Correlativo Interno</div>
...
$sql=" SP_CORRELATIVO_INTERNO_LISTA '".$_SESSION['iCodOficinaLogin']."','".date('Y')."' ";
//echo $sql;
/*
$sql="select * from Tra_M_Oficinas ";
$sql.=" WHERE iCodOficina>0 ";
...
<tr>
<td width="357" class="headCellColum">Siglas</td>
...
<?php echo paginar($pag, $total, $tampag, "iu_correlativo_interno.php?iCodOficina=".$_REQUEST['iCodOficina']."&pag=");?>
<table width="900" border="0" align="center">
  <tr>
    <td align="right"><a href='cst_nuevo_corre_int.php?iCodOficina=<?=$_REQUEST['iCodOficina']?>'>Nuevo Correlativo</a>&nbsp;&nbsp;</td>
  </tr>
</table>
