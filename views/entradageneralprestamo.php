...
<div class="AreaTitulo">Consulta >> Prestamos / Documento de Entrada</div>



							<form name="frmConsultaEntrada" method="GET" action="entradageneralprestamo.php">
						<tr>
...
<table width='100%' border="0">
   <tr>
    ...
    <tr>
        ...
        <td><img src="images/monedas.png"></td>
        <td>Prestamo</td>
    </tr>
    <tr>

        <td  width='2%'><img src="images/monedas_off.png"></td>
        <td>Prestamo Enviado</td>
    </tr>
</table>
...
<tr>
	...
	<td width="300" class="headCellColum">Remitente</td> 
    ...
    <td valign="top" align="left">
       ...
       <a href="registroDetalleFlujoTupa.php?iCodTupa=<?=$Rs['iCodTupa']?>" rel="lyteframe" title="Detalles Flujo Tupa" rev="width: 880px; height: 300px; scrolling: auto; border:no"><?=$RsTup["cNomTupa"]?></a>
    	...
    	?>
    		...
    		<script>
            function confirmar(){
                if(confirm('Esta seguro de solicitar el prestamo para este documento?'))
                    return true;
                else
                    return false;
            }
            ...
            <?php
                $sqlx1= "select * from T_MAE_PRESTAMO where iCodTramite='".$Rs[iCodTramite]."' and Cod_estado_prestamo!='3'";
                $queryx1=sqlsrv_query($cnx,$sqlx1);
                //$rsx1=sqlsrv_fetch_array($queryx1);
                if(sqlsrv_fetch_array($queryx1)>0){
                    $img1="images/monedas_off.png";
                    $mensaje_img1="Prestamo Enviado";
            ?>
                <img src="<?php echo $img1;?>" title="<?php echo $mensaje_img1;?>" border='0' width="16px">
            <?php
                }else{
                    $img1="images/monedas.png";
                    $mensaje_img1="Prestamo";
            ?>
                <a href="prestamodata.php?id=<?php echo $Rs[iCodTramite];?>" onclick="return confirmar()">
                <img src="<?php echo $img1;?>" title="<?php echo $mensaje_img1;?>" border='0' width="16px">
                </a>
            <?php
                }
