...
if ($_SESSION['CODIGO_TRABAJADOR'] != ""){
	...
	/* I MAX */
		$dest = "wrapper.php?p_bcType=".$p_bcType."&p_text=".$cCodificacion."&p_xDim=".$p_xDim."&p_w2n=".$p_w2n."&p_charGap=".$p_charGap."&p_invert=".($p_invert??'')."&p_charHeight=".$p_charHeight."&p_type=".$p_type."&p_label=".$p_label."&p_rotAngle=".$p_rotAngle."&p_checkDigit=".$p_checkDigit.""
	/* F MAX */
?>
    <!DOCTYPE html>
    <html lang="es">
            ...
            <div class="col-md-12 mb-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header text-center ">
                        <?php
                            $_POST['nFlgClaseDoc'] = str_replace('"','',stripslashes($_POST['nFlgClaseDoc']));
                            ...
                            <table align="center" cellpadding="3" cellspacing="3" border="0">
                                ...
                                <tr>
                                    <td align="center" style="border-right:1px solid #043D75;border-left:1px solid #043D75;border-top:1px solid #043D75;border-bottom:1px solid #043D75;">
                                        ...
                                        /*<!--- --------------------------------------------------------------------- --->
                                        <!-- I MAX -->	*/
                                        echo $img_final="<img src=".$PNG_WEB_DIR.basename($filename).">" ?>
    ...
    <?php include("includes/pie.php");?>
                                <script language="Javascript">
                                    ...
                                    function crearVentana() {
                                        ventana = window.open("registroConCluidoPrint.php?iCodTramite=<?=$_POST['iCodTramite']?>&nCodBarra=<?=$_POST['nCodBarra']?>&cCodificacion=<?=$_POST['cCodificacion']?>&cPassword=<?=$_POST['cPassword']?>&fFechaHora=<?=$fFechaHora?>","nuevo","width=330,height=240");
