...
//  Sql es ejecutado en SP
    $sqlAdd.=" SP_DOC_SALIDA_INSERT '$cCodificacion',	'".$_SESSION['CODIGO_TRABAJADOR']."', '".$_SESSION['iCodOficinaLogin']."', '$_POST[cCodTipoDoc]', '$fFecActual', '$RsJefe[iCodTrabajador]', '$_POST[cReferencia]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$_POST[nFlgRpta]', '$_POST[nNumFolio]', $fFecPlazo, '$_POST[cSiglaAutor]', '$fFecActual', '$_POST[iCodRemitente]' ";
...
//  Sql es ejecutado en SP
    ...
    $sqlAdMv.="SP_DOC_SALIDA_MOVIMIENTO_INSERT '$RsUltTra[iCodTramite]', '".$_SESSION['CODIGO_TRABAJADOR']."',     '".$_SESSION['iCodOficinaLogin']."',  '$_POST['cAsunto']', '$_POST[cObservaciones]', '$fFecActual', '$fFecActual' ";
...
//  Sql es ejecutado en SP
    ...
    $sqlUpd="SP_DOC_ENTRADA_CON_TUPA_UPDATE  '$_POST[cCodTipoDoc]', '".$_POST['cNroDocumento']."', '$_POST[iCodRemitente]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$_POST[iCodTupaClase]',  '$_POST['iCodTupa']',  '$_POST[cReferencia]',  '$_POST[iCodIndicacion]','$_POST[nNumFolio]', '$_POST[nTiempoRespuesta]', '$_POST[cNomRemite]','$fFecActual','$fFecActual', '$_POST[iCodTramite]' ";
...
//    $sqlUpd.="WHERE iCodTramite='$_POST[iCodTramite]'";
	...
	$sqlUpdMovE=" SP_DOC_ENTRADA_MOV_UPDATE '$_POST[cCodTipoDoc]', '$_POST['cAsunto']', '$_POST[cObservaciones]','$fFecActual', '$RsUpdMovimineto[iCodMovimiento]' ";
...
//  Sql es ejecutado en SP
	$fFecActual=$_POST['fFecRegistro'];
    $sqlUpd="SP_DOC_ENTRADA_SIN_TUPA_UPDATE  '$_POST[cCodTipoDoc]', '".$_POST['cNroDocumento']."', '$_POST[iCodRemitente]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$_POST[cReferencia]',  '$_POST[iCodIndicacion]','$_POST[nNumFolio]', '$_POST[nTiempoRespuesta]', '$_POST[cNomRemite]', '$fFecActual','$fFecActual','$_POST[iCodTramite]' ";
...
//		echo $sqlUpd;
	...
	$sqlUpdMovE=" SP_DOC_ENTRADA_MOV_UPDATE '$_POST[cCodTipoDoc]', '$_POST['cAsunto']', '$_POST[cObservaciones]','$fFecActual', '$RsUpdMov[iCodMovimiento]' ";
	$rsUpdMovE=sqlsrv_query($cnx,$sqlUpdMovE);
...
//  Sql es ejecutado en SP
    ...
    $sqlUpd="SP_DOC_ENTRADA_INTERNO_UPDATE '$_POST[cCodTipoDoc]', '$_POST[iCodTrabajadorSolicitado]', '$_POST[cReferencia]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$_POST[nFlgRpta]', '$_POST[nNumFolio]', $fFecPlazo, '$_POST[cSiglaAutor]' , '$_POST[iCodTramite]' ";
...
//    $sqlUpd.="WHERE iCodTramite='$_POST[iCodTramite]'";
  ...
  case 14: //a�adir movimiento de oficina edit
    		...
    		echo "<html>";
   			...
   			echo "<input type=hidden name=fFecPlazo value=\"".$_POST[fFecPlazo]."\">";
   			echo "<input type=hidden name=nFlgEnvio value=\"".$_POST[nFlgEnvio]."\">";
			echo "<input type=hidden name=nFlgEnvio value=\"".$_POST[cSiglaAutor]."\">";
   			echo "</form>";
   			echo "</body>";
   			echo "</html>";
	break;
...
//  Sql es ejecutado en SP
	$fFecActual=$_POST['fFecRegistro'];   	
    $sqlUpd="SP_DOC_SALIDA_UPDATE '$_POST[cCodTipoDoc]', '$_POST[iCodTrabajadorSolicitado]', '$_POST[cReferencia]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$_POST[nFlgRpta]', '$_POST[nNumFolio]', $fFecPlazo, '$_POST[cSiglaAutor]', $iCodRemitente,'$fFecActual','$fFecActual', '$_POST[iCodTramite]'  ";
	//echo  $sqlUpd;
...
//		echo $sqlUpd;
	...
	$sqlUpdMovE=" SP_DOC_SALIDA_MOV_UPDATE  '$_POST['cAsunto']', '$_POST[cObservaciones]','$fFecActual', '$RsUpdMovimineto[iCodMovimiento]' ";
	$rsUpdMovE=sqlsrv_query($cnx,$sqlUpdMovE);
  ...
  case 20: //a�adir movimiento temporal
      ...
      $RsTrb=sqlsrv_fetch_array($rsTrb);
    	...
    	$sqlAdMv.="(iCodTramite,           iCodTrabajadorRegistro,             nFlgTipoDoc,  iCodOficinaOrigen,             iCodOficinaDerivar,    iCodTrabajadorDerivar,    iCodIndicacionDerivar,    cPrioridadDerivar,    cAsuntoDerivar,    cObservacionesDerivar,     fFecDerivar,  fFecMovimiento, nEstadoMovimiento, cFlgTipoMovimiento)";
    	$sqlAdMv.=" VALUES ";
    	$sqlAdMv.="('$_POST[iCodTramite]', '".$_SESSION['CODIGO_TRABAJADOR']."',     2,            '".$_SESSION['iCodOficinaLogin']."', '$lstOficinasSel[$i]', '$RsTrb[iCodTrabajador]', '$_POST[iCodIndicacion]', '$_POST[cPrioridad]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$fFecActual', '$fFecActual',  1,                 1)";
    	$rsAdMv=sqlsrv_query($cnx,$sqlAdMv);
