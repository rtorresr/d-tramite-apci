    ...
    <page backtop="15mm" backbottom="10mm" backleft="10mm" backright="10mm">
                        ...
                        <tr>
                            ...
                            <td style="width:65%;text-align:left; border: solid 0px #585858;font-size:14px;font-family:Times"><b>
                                    <?php
                                        ...
                                        echo $Rs['fFecRegistro']->format('d/m/Y h:i:s');
                                    ?>
                                    </b>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width:65%;text-align:left; border: solid 0px #585858;font-size:14px;font-family:Times"><b>
                                    <?php
                                        ...
                                        */
                                        //echo date("d-m-Y G:i:s", strtotime($RsM1['fFecDerivar']));
                                        echo $Rs['fFecDerivar']->format('d/m/Y h:i:s');
                                        }
                                    ?>
                                    </b>
                            </td>
        ...
        <table border="1" style="width:100%;border: solid 1px #585858; border-collapse: collapse" align="left">
            <tr>
              ...
              <td style="width:20%; text-align: left; border: solid 1px #585858;font-size:14px;font-family:Times">Numero de documento</td>
            ...
            <tr>
                ...
                <?php
                    ...
                    */
                    //echo date("d-m-Y G:i:s", strtotime($Rs['fFecDerivar']));
                    echo $Rs['fFecDerivar']->format('d/m/Y h:i:s');
                    }
                ?>
                </td>
        ...
        <table style="width:100%;border: solid 0px #585858; border-collapse: collapse" align="left">
            ...
            <tr>
                <td>
                    <?php $sqlRefs="SELECT * FROM Tra_M_Tramite_Referencias WHERE iCodTramite='".$_GET['iCodTramite']."'";
                         $rsRefs=sqlsrv_query($cnx,$sqlRefs);?>
                     <?php  while ($RsRefs=sqlsrv_fetch_array($rsRefs)){
                        echo trim($RsRefs['cReferencia']); echo " ********* ";
