<?
/**************************************************************************************
NOMBRE DEL PROGRAMA: registroTramiteCop.php
SISTEMA: SISTEMA  DE TR�MITE DOCUMENTARIO DIGITAL
OBJETIVO: Modificar Copias
...
<div class="AreaTitulo">
	...
	$sqlCop="SELECT * FROM Tra_M_Tramite_Movimientos WHERE iCodTramite=".$idt." AND cFlgTipoMovimiento=4 And iCodMovimiento = ".$id." ORDER BY iCodMovimiento ASC";
		   	$rsM=sqlsrv_query($cnx,$sqlCop);
		echo $sqlM;
				$recorrido=1;
