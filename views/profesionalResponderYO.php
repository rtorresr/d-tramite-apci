...
<div class="AreaTitulo">Responder Documento</div>	
				...
				<fieldset>
					...
					<?php
									...
									$sqlTrb="SELECT * FROM Tra_M_Trabajadores WHERE iCodOficina='$_GET[iCodOficina1]' AND iCodTrabajador!='".$_SESSION['CODIGO_TRABAJADOR']."' AND iCodCategoria=5 AND nFlgEstado=1 ORDER BY cApellidosTrabajador ASC";
