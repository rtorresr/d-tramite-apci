...
session_start();
$pageTitle = "Bandeja de Finalizados - Profesional";
$activeItem = "profesionalFinalizados.php";
$navExtended = true;
$pag = $_GET['pag']??1;
...
<!--Main layout-->
     ...
     <div class="container-fluid">
         ...
         <div class="row wow fadeIn">
             ...
             <div class="col-md-12 mb-12">
                 ...
                 <div class="card">
                      <!-- Card header -->
                     <div class="card-header text-center ">BANDEJA DE FINALIZADOS - PROFESIONAL</div>
                      <!--Card content-->
 ...
 function paginar($actual, $total, $por_pagina, $enlace, $maxpags=0) {
                                         ...
                                         $sqlTra="SELECT Tra_M_Tramite.iCodTramite as Tramite, 
                                                (convert(char(10),fFecDelegado, 120) +  + Convert(char(8),fFecDelegado, 114))  as fFecDelegadoz,
                                                (convert(char(10),fFecDelegadoRecepcion, 120) +  + Convert(char(8),fFecDelegadoRecepcion, 114))  as fFecDelegadoRecepcionz,
                                                (convert(char(10),fFecEnviar, 120) +  + Convert(char(8),fFecEnviar, 114))  as fFecEnviarz,
                                                (convert(char(10),fFecDerivar, 120) +  + Convert(char(8),fFecDerivar, 114))  as fFecDerivarz,
                                                (convert(char(10),fFecRegistro, 120) +  + Convert(char(8),fFecRegistro, 114))  as fFecRegistroz
                                          ,* 
                                         ...
                                         $sqlTra.="AND ((Tra_M_Tramite_Movimientos.iCodOficinaDerivar='".$_SESSION['iCodOficinaLogin']."' AND Tra_M_Tramite_Movimientos.iCodTrabajadorDelegado='".$_SESSION['CODIGO_TRABAJADOR']."' ) ";
                                         $sqlTra.="OR Tra_M_Tramite_Movimientos.iCodTrabajadorEnviar='".$_SESSION['CODIGO_TRABAJADOR']."' ) ";
                                         $sqlTra.="AND Tra_M_Tramite_Movimientos.nEstadoMovimiento=5 ";
                                         ...
                                         <div class="table-responsive">
                                             <table class="table table-hover ">
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td class="headColumnas">Tipo Documento / Raz&oacute;n Social</td>
                                                         ...
                                                         <tr bgcolor="<?=$color?>" onMouseOver="this.style.backgroundColor='#BFDEFF'" OnMouseOut="this.style.backgroundColor='<?=$color?>'">
                                                             <td width="92" valign="top">
                                                                 ...
                                                                 <?php if($RsTra['nFlgTipoDoc']==1){?>
                                                                     <a class="modal-trigger tooltipped" data-send="<?=$RsTra['iCodTramite']?>" onclick="getvalue(this)" data-position="left" data-tooltip="Detalle del Trámite" href="#modal1bpf" >
                                                                         <?=$RsTra['cCodificacion']?>
                                                                     </a>
                                                                 ...
                                                                 if($RsTra['nFlgTipoDoc']==4){
                                                                     ?>
                                                                     <a class="modal-trigger tooltipped" data-send="<?=$RsTra['iCodTramiteRel']?>" onclick="getvalue(this)" data-position="left" data-tooltip="Detalle del Trámite" href="#modal1bpf" >
                                                                         <?=$RsTra['cCodificacion']?>
                                                                     </a>
                                                             ...
                                                             <td width="80" align="left" valign="top">
                                                                 <?php if($RsTra['cFlgTipoMovimiento']==1 or $RsTra['cFlgTipoMovimiento']==6){?>
                                                                     <div><?=''??$RsTra['fFecDerivarz']->format("d-m-Y")/*date("d-m-Y", strtotime($RsTra['fFecDerivar']))*/;?></div>
                                                                     <div style="font-size:10px"><?=''??$RsTra['fFecDerivarz']->format("h:i A");?></div>
                                                                 <?php } ?>
                                                                 <?php if($RsTra['cFlgTipoMovimiento']==2  ){?>
                                                                     <div><?=$RsTra['fFecEnviarz']->format("d-m-Y")/*date("d-m-Y", strtotime($RsTra[fFecEnviar]))*/;?></div>
                                                                     <div style="font-size:10px"><?=$RsTra['fFecEnviarz']->format("h:i A");?></div>
                                                                 <?php } ?>
                                                             </td>
                                                             <td width="80" align="left" valign="top">
                                                                 <?php     if($RsTra['fFecDelegadoRecepcionz']==""){
                                                                     echo "<div style=color:#ff0000>sin aceptar</div>";
                                                                 }Else{
                                                                     echo "<div style=color:#0154AF>".''??$RsTra['fFecDelegadoRecepcionz']->format("d-m-Y")/*date("d-m-Y", strtotime($RsTra['fFecDelegadoRecepcion']))*/."</div>";
                                                                     echo "<div style=color:#0154AF;font-size:10px>".''??$RsTra['fFecDelegadoRecepcionz']->format("h:i A")."</div>";
                                                                 }
                                                                 ?>
                                                             </td>
                                                             <td>
                                                                 <?php     if($RsTra['iCodTrabajadorDelegado']!=""){
                                                                     ...
                                                                     echo "<div style=color:#0154AF>".''??$RsTra['fFecDelegadoz']->format("d-m-Y")/*date("d-m-Y", strtotime($RsTra[fFecDelegado]))*/."</div>";
                                                                     echo "<div style=color:#0154AF;font-size:10px>".''??$RsTra['fFecDelegadoz']->format("h:i A")."</div>";
                                                                 }
                                                                 ...
                                                                 if($RsTra['nEstadoMovimiento']==5){echo $RsTra['cObservacionesFinalizar'];}
                                                                 ?>
                                                             </td>
                                                             ...
                                                             <td width="60" valign="top">
                                                                 <a href="profesionalData.php?iCodMovimiento=<?=$RsTra['iCodMovimiento']?>&opcion=11"><img src="images/icon_retornar.png" width="16" height="16" border="0" alt="Anular respuesta">
                                                             </td>
                                                         </tr>
                                                         <?php
         }
...
<script Language="JavaScript">
    ...
    function getvalue(e) {
        ...
        const nodocontent= document.querySelector('div#modal1bpf').querySelector('div.modal-content');
