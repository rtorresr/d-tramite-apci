<?
/**************************************************************************************
NOMBRE DEL PROGRAMA: iu_nuevo_grupo_tramite.php
...
OBJETIVO: Mantenimiento de la Tabla Maestra de Grupos de Tramite DOCUMENTARIO DIGITAL para el Perfil Administrador
          -> Crear Registro de Grupos de Tramite DOCUMENTARIO DIGITAL
...
<form action="../controllers/ln_nuevo_grupo_tramite.php" onSubmit="return validar(this)" method="post" name="form1">
        ...
        <table border="0">
           <tr>
              <td width="75"></td>
              <td width="159" >Descripci&oacute;n :</td>
              
              <input name="txtgrupo" type="text" id="txtgrupo" maxlength="30"  size="40" class="FormPropertReg form-control"></td>
           </tr>
           <tr>
