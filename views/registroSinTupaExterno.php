...
function Registrar()
{
  ...
  if (document.frmRegistro.cNomRemite.value.length == "")
  {
    alert("Ingrese el que Remite");
    document.frmRegistro.cNomRemite.focus();
    return (false);
  }
...
<div class="AreaTitulo">Registro de entrada sin tupa (Web)</div>	
		...
		<tr>
			...
			<td>
				...
				</div>&nbsp;<span class="FormCellRequisito">*</span>
			</td>
		</tr>
		...
		<tr>
			...
			<td valign="top" colspan="3">
				<input type="text" style="width:250px;text-transform:uppercase;" name="cNroDocumento" <?=((isset($fondo1))?$fondo1:'')?>
					   value="<?php echo stripslashes((isset($_POST['cNroDocumento']))?$_POST['cNroDocumento']:'');?>" class="FormPropertReg form-control"  id="cNroDocumento" />&nbsp;
				<input name="button" type="button" class="btn btn-primary" value="ChkDoc." onclick="releer();" >&nbsp;
					<span class="FormCellRequisito">*</span><?=((isset($eti))?$eti:'')?>
			</td>
		</tr>
			...
			<td valign="top" colspan="3">
				<table cellpadding="0" cellspacing="2" border="0">
					<tr>
						<?php 
							$sqlRemitente = "SELECT cNombresTrabajador FROM Tra_M_Trabajadores 
						...
						<td>
							<input id="cNombreRemitente" name="cNombreRemitente" class="FormPropertReg form-control" 
								   value="<?php echo trim($RsRemitente['cNombresTrabajador']); ?>" style="width:380px" readonly>
						</td>
                    <td>
			...
			<td valign="top">
					<textarea name="cAsunto" style="width:340px;height:55px" class="FormPropertReg form-control"><?=((isset($_POST['cAsunto']))?$_POST['cAsunto']:'')?></textarea>&nbsp;<span class="FormCellRequisito">*</span>
			</td>
			...
			<!-- <tr>
				...
				<td>
					<?php //Consulta para rellenar el combo Oficina
						$sqlOficina = "SELECT TMT.iCodOficina, cNomOficina, cNombresTrabajador, cApellidosTrabajador, iCodTrabajador 
									   			FROM Tra_M_Trabajadores TMT
								   	  		INNER JOIN Tra_M_Oficinas TMO ON TMT.iCodOficina = TMO.iCodOficina
								   	   		WHERE TMT.iCodPerfil = 2 AND TMT.iCodCategoria = 5 AND TMT.ES_EXTERNO = 0 "; 
		      ...
		      ?>
					<select name="iCodOficinaResponsable" style="width:340px;" class="FormPropertReg form-control">
						<option value=<?php echo $RsOficina["iCodOficina"]; ?>><?php echo $RsOficina["cNomOficina"]; ?></option>
					</select>
				</td>
				...
				<td>
					<select name="iCodTrabajadorResponsable" id="responsable" style="width:340px;" class="FormPropertReg form-control">
						<option value=<?php echo $RsOficina["iCodTrabajador"]; ?>><?php echo $RsOficina["cApellidosTrabajador"].", ".$RsOficina["cNombresTrabajador"]; ?></option>
							<?php
