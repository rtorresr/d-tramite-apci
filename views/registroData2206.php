...
//			$sqlMov.="('$RsUltTra[iCodTramite]', '".$_SESSION['CODIGO_TRABAJADOR']."', 1,           '".$_SESSION['iCodOficinaLogin']."', '$_POST[iCodOficinaResponsable]', '$_POST[iCodTrabajadorResponsable]', '$_POST[cCodTipoDoc]', '$_POST[iCodIndicacion]', '$fFecActual', 1,                '$fFecActual',   '$_POST[nFlgEnvio]',1)";
  ...
  case 2: //registrar interno oficinas ///////////////////////////////////////////////////////////////////////////
    ...
    // Jefe de Oficina 
    $rsJefe=sqlsrv_query($cnx,"SELECT iCodTrabajador FROM Tra_M_Trabajadores WHERE iCodOficina='".$_SESSION['iCodOficinaLogin']."' AND iCodCategoria='5' ");
	$RsJefe=sqlsrv_fetch_array($rsJefe);


//  Sql es ejecutado en SP
    $sqlAdd.=" SP_DOC_ENTRADA_INTERNO_INSERT '$cCodificacion',	'".$_SESSION['CODIGO_TRABAJADOR']."', '".$_SESSION['iCodOficinaLogin']."','$_POST[cCodTipoDoc]', '$fFecActual', '$RsJefe[iCodTrabajador]', '$_POST[cReferencia]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$_POST[nFlgRpta]', '$_POST[nNumFolio]', $fFecPlazo, '$_POST[nFlgEnvio]', '$fFecActual','$_POST[cSiglaAutor]'";
...
//  Sql es ejecutado en SP
    		...
    		$sqlAddCargo.=" SP_DOC_SALIDA_MULTIPLE_INSERT '$RsUltTra[iCodTramite]' ,'$cCodificacion','$_POST[iCodRemitente]', $_SESSION['iCodOficinaLogin'], '$_POST['cAsunto']', '".$_SESSION['CODIGO_TRABAJADOR']."' ";
...
//  Sql es ejecutado en SP
   ...
   // $sqlAdMv2="SP_DOC_SALIDA_MOVIMIENTO_INSERT '$RsUltTra[iCodTramite]', '".$_SESSION['CODIGO_TRABAJADOR']."',     '".$_SESSION['iCodOficinaLogin']."',  '$_POST['cAsunto']', '$_POST[cObservaciones]', '$fFecActual', '$fFecActual' ";
    		...
    		$sqlBusRef="SELECT * FROM Tra_M_Tramite WHERE cCodificacion='$_POST[cReferencia]' ";
				...
				if(sqlsrv_has_rows($rsBusRef)>0){
						...
						if($RsBusRef[nFlgTipoDoc]==1){
    						...
    						$sqlAdRf.=" VALUES ";
    						$sqlAdRf.="('$RsBusRef[iCodTramite]', '".$_SESSION['CODIGO_TRABAJADOR']."',     3,           '".$_SESSION['iCodOficinaLogin']."', '$_POST[cCodTipoDoc]',  1,                   6,                      '$_POST['cAsunto']', '$_POST[cObservaciones]', '$fFecActual', '$cCodificacion',   '$fFecActual',  1, 						    5,                  1,		'$RsUltTra[iCodTramite]')";
    						$rsAdRf=sqlsrv_query($cnx,$sqlAdRf);
    				}
				}
    }
...
//  Sql es ejecutado en SP
 	$fFecActual2=date("Ymd", strtotime($_POST['fFecRegistro']))." ".date("G:i",strtotime($_POST['fFecRegistro']));  
    $sqlUpd="SP_DOC_ENTRADA_CON_TUPA_UPDATE  '$_POST[cCodTipoDoc]', '".$_POST['cNroDocumento']."', '$_POST[iCodRemitente]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$_POST[iCodTupaClase]',  '$_POST['iCodTupa']',  '$_POST[cReferencia]',  '$_POST[iCodIndicacion]','$_POST[nNumFolio]', '$_POST[nTiempoRespuesta]', '$_POST[cNomRemite]','$fFecActual2','$fFecActual2', '$_POST[iCodTramite]' ";
...
//    $sqlUpd.="WHERE iCodTramite='$_POST[iCodTramite]'";
		...
		if($_POST[iCodOficinaResponsable]!="" AND $_POST[numMov]==0){
				...
				$sqlMov.=" VALUES ";
				$sqlMov.="('$_POST[iCodTramite]', '".$_SESSION['CODIGO_TRABAJADOR']."', 1,           '".$_SESSION['iCodOficinaLogin']."', '$_POST[iCodOficinaResponsable]', '$_POST[iCodTrabajadorResponsable]', '$_POST[cCodTipoDoc]', '$_POST[iCodIndicacion]', '$fFecActual2', 1,                '$fFecActual2',   1)";
   			$rsMov=sqlsrv_query($cnx,$sqlMov);
   	}	
	...
	$sqlUpdMovE=" SP_DOC_ENTRADA_MOV_UPDATE '$_POST[cCodTipoDoc]', '$_POST['cAsunto']', '$_POST[cObservaciones]','$fFecActual2', '$RsUpdMovimineto[iCodMovimiento]' ";	
...
//  Sql es ejecutado en SP
	$fFecActual2=date("Ymd", strtotime($_POST['fFecRegistro']))." ".date("G:i",strtotime($_POST['fFecRegistro']));  
    $sqlUpd="SP_DOC_ENTRADA_SIN_TUPA_UPDATE  '$_POST[cCodTipoDoc]', '".$_POST['cNroDocumento']."', '$_POST[iCodRemitente]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$_POST[cReferencia]',  '$_POST[iCodIndicacion]','$_POST[nNumFolio]', '$_POST[nTiempoRespuesta]', '$_POST[cNomRemite]', '$fFecActual2','$fFecActual2','$_POST[iCodTramite]' ";
...
//		echo $sqlUpd;
	...
	$sqlUpdMovE=" SP_DOC_ENTRADA_MOV_UPDATE '$_POST[cCodTipoDoc]', '$_POST['cAsunto']', '$_POST[cObservaciones]','$fFecActual2', '$RsUpdMov[iCodMovimiento]' ";	
	$rsUpdMovE=sqlsrv_query($cnx,$sqlUpdMovE);
    ...
    // Se desarroll� el SP pero no se sabe como probarlo por eso no se implementa 
	  ...
	  $rsTram=sqlsrv_query($cnx,"SELECT * FROM Tra_M_Tramite WHERE iCodTramite='$_POST[iCodTramite]'");
		...
		for($i=1; $i<=$_POST[CantCopias]; $i++){
  		...
  		$sqlMov="INSERT INTO Tra_M_Tramite_Movimientos ";
			...
			$sqlMov.=" VALUES ";
			$sqlMov.="('$_POST[iCodTramite]', '".$_SESSION['CODIGO_TRABAJADOR']."', 1, 						'".$_SESSION['iCodOficinaLogin']."', '$iCodOficinaResponsableSelect', '$iCodTrabajadorResponsableSelect', '$RsTram['cAsunto']', '$cObservaciones',       '$RsTram[cCodTipoDoc]', '$iCodIndicacionSelect', '$fFecActual', 1,                '$fFecActual',   1,	4)";
   		//echo $sqlMov."<br><br>";
   		$rsMov=sqlsrv_query($cnx,$sqlMov);
  	}
  ...
  case 14: //a�adir movimiento de oficina edit
    ...
    $sqlUpd.="WHERE iCodTramite='$_POST[iCodTramite]'";
		...
		for ($i=0;$i<count($_POST[lstTrabajadoresSel]);$i++){
			$lstTrabajadoresSel=$_POST[lstTrabajadoresSel];
			$sqlMov="INSERT INTO Tra_M_Tramite_Movimientos ";
			$sqlMov.="(iCodTramite,						nFlgTipoDoc, iCodTrabajadorRegistro,				 iCodOficinaOrigen,           fFecMovimiento,           nEstadoMovimiento, iCodOficinaDerivar,            iCodTrabajadorEnviar,      cObservacionesEnviar, 		 fFecEnviar,              cFlgTipoMovimiento)";
			$sqlMov.=" VALUES ";
			$sqlMov.="('$_POST[iCodTramite]', '2', 				 '".$_SESSION['CODIGO_TRABAJADOR']."', $_SESSION['iCodOficinaLogin'], '$_POST[fFecMovimiento]', 1,								 '".$_SESSION['iCodOficinaLogin']."', '$lstTrabajadoresSel[$i]', '$_POST[cObservaciones]', '$_POST[fFecMovimiento]', 2)";
   		$rsMov=sqlsrv_query($cnx,$sqlMov);
		}
...
//		echo $sqlUpd;
    ...
    if($_POST[cReferencia]!=""){
			if($_POST[cReferenciaOriginal]!=$_POST[cReferencia]){
    				$sqlBusRef="SELECT * FROM Tra_M_Tramite WHERE cCodificacion='$_POST[cReferencia]'";
						...
						if(sqlsrv_has_rows($rsBusRef)>0){
								$RsBusRef=sqlsrv_fetch_array($rsBusRef);
								if($RsBusRef[nFlgTipoDoc]==1){
										$sqlBusCod="SELECT * FROM Tra_M_Tramite WHERE iCodTramite='$_POST[iCodTramite]'";
										$rsBusCod=sqlsrv_query($cnx,$sqlBusCod);	
										$RsBusCod=sqlsrv_fetch_array($rsBusCod);
										$rsDel=sqlsrv_query($cnx,"DELETE FROM Tra_M_Tramite_Movimientos WHERE cReferenciaDerivar='$RsBusCod[cCodificacion]' AND cFlgTipoMovimiento=5");
										//$rsDel=sqlsrv_query($cnx,"DELETE FROM Tra_M_Tramite_Movimientos WHERE iCodTramite='$RsBusRef[iCodTramite]' AND cFlgTipoMovimiento=5");
											
										$sqlAdRf="INSERT INTO Tra_M_Tramite_Movimientos ";
    								$sqlAdRf.="(iCodTramite,              iCodTrabajadorRegistro,             nFlgTipoDoc, iCodOficinaOrigen,              cCodTipoDocDerivar,    iCodOficinaDerivar, iCodIndicacionDerivar, cAsuntoDerivar,    cObservacionesDerivar,    fFecDerivar,   cReferenciaDerivar,      fFecMovimiento, nEstadoMovimiento, cFlgTipoMovimiento, nFlgEnvio,				iCodTramiteDerivar)";
    								$sqlAdRf.=" VALUES ";
    								$sqlAdRf.="('$RsBusRef[iCodTramite]', '".$_SESSION['CODIGO_TRABAJADOR']."',     3,           '".$_SESSION['iCodOficinaLogin']."', '$_POST[cCodTipoDoc]',  1,                  3,                     '$_POST['cAsunto']', '$_POST[cObservaciones]', '$fFecActual', '$_POST[cCodificacion]', '$fFecActual',  1, 	     5,           1,				'$_POST[iCodTramite]'	)";
    								$rsAdRf=sqlsrv_query($cnx,$sqlAdRf);
										//echo "DELETE FROM Tra_M_Tramite_Movimientos WHERE iCodTramite='$RsBusRef[iCodTramite]' AND cFlgTipoMovimiento=5";
										//echo $sqlAdRf;
								}
						}
				}
		if($_POST[cReferenciaOriginal]==$_POST[cReferencia]){
			...
			$rsBusCod=sqlsrv_query($cnx,$sqlBusCod);	
			$RsBusCod=sqlsrv_fetch_array($rsBusCod);
				$sqlBusRef2="SELECT * FROM Tra_M_Tramite_Movimientos WHERE cReferenciaDerivar='$RsBusCod[cCodificacion]' ";
				$rsBusRef2=sqlsrv_query($cnx,$sqlBusRef2);
				if(sqlsrv_has_rows($rsBusRef2)<1){
					$sqlAdRf="INSERT INTO Tra_M_Tramite_Movimientos ";
    			$sqlAdRf.="(iCodTramite,              iCodTrabajadorRegistro,             nFlgTipoDoc, iCodOficinaOrigen,              cCodTipoDocDerivar,    iCodOficinaDerivar,  iCodIndicacionDerivar,  cAsuntoDerivar,    cObservacionesDerivar,    fFecDerivar,   cReferenciaDerivar, fFecMovimiento, nEstadoMovimiento, cFlgTipoMovimiento, nFlgEnvio,				iCodTramiteDerivar)";
    			$sqlAdRf.=" VALUES ";
    			$sqlAdRf.="('$RsBusRef[iCodTramite]', '".$_SESSION['CODIGO_TRABAJADOR']."',     3,           '".$_SESSION['iCodOficinaLogin']."', '$_POST[cCodTipoDoc]',  1,                   3,                      '$_POST['cAsunto']', '$_POST[cObservaciones]', '$fFecActual', '$cCodificacion',   '$fFecActual',  1, 						    5,                  1,			'$_POST[iCodTramite]')";
    			$rsAdRf=sqlsrv_query($cnx,$sqlAdRf);
				}
				else
				{
			...
			$rsBusCod=sqlsrv_query($cnx,$sqlBusCod);	
			$RsBusCod=sqlsrv_fetch_array($rsBusCod);
			$rsSel=sqlsrv_query($cnx,"SELECT * FROM Tra_M_Tramite_Movimientos WHERE cReferenciaDerivar='$RsBusCod[cCodificacion]' AND cFlgTipoMovimiento=5");
			$RsSel=sqlsrv_fetch_array($rsSel);
		 
$sqlUpdMovE=" SP_DOC_SALIDA_MOV_UPDATE  '$_POST['cAsunto']', '$_POST[cObservaciones]','$fFecActual', '$RsSel[iCodMovimiento]' ,'$_POST[iCodTramite]'";	
	$rsUpdMovE=sqlsrv_query($cnx,$sqlUpdMovE);
				}
    ...
    $sqlAdd="INSERT INTO Tra_M_Tramite ";
    $sqlAdd.="(nFlgTipoDoc, nFlgClaseDoc, cCodificacion,     iCodTrabajadorRegistro,        iCodOficinaRegistro,           cCodTipoDoc,           fFecDocumento,	iCodOficinaSolicitado, 				   cReferencia, 				   cAsunto,           cObservaciones, 				 iCodIndicacion, nFlgRpta,					 nNumFolio,						fFecPlazo,  cSiglaAutor,   				 fFecRegistro,	 iCodRemitente,					 nFlgEstado, nFlgEnvio,			cNomRemite)";
    $sqlAdd.=" VALUES ";
    ...
    if($_POST[cReferencia]!=""){
    		$sqlBusRef="SELECT * FROM Tra_M_Tramite WHERE cCodificacion='$_POST[cReferencia]'";
    			...
    			$sqlAdRf.="(iCodTramite,              iCodTrabajadorRegistro,             nFlgTipoDoc, iCodOficinaOrigen,              cCodTipoDocDerivar,    iCodOficinaDerivar,  iCodIndicacionDerivar,  cAsuntoDerivar,    cObservacionesDerivar,    fFecDerivar,   cReferenciaDerivar, fFecMovimiento, nEstadoMovimiento, cFlgTipoMovimiento, nFlgEnvio,				iCodTramiteDerivar)";
    			$sqlAdRf.=" VALUES ";
    			$sqlAdRf.="('$RsBusRef[iCodTramite]', '".$_SESSION['CODIGO_TRABAJADOR']."',     3,           '".$_SESSION['iCodOficinaLogin']."', '$_POST[cCodTipoDoc]',  1,                   3,                      '$_POST['cAsunto']', '$_POST[cObservaciones]', '$fFecActual', '$cCodificacion',   '$fFecActual',  1, 						    5,                  1,			'$RsUltTra[iCodTramite]')";
    			$rsAdRf=sqlsrv_query($cnx,$sqlAdRf);
				}
    }	
	...
	$sqlUpdMovE=" SP_DOC_SALIDA_MOV_UPDATE  '$_POST['cAsunto']', '$_POST[cObservaciones]','$fFecActual', '$RsSel[iCodMovimiento]' ";	
	$rsUpdMovE=sqlsrv_query($cnx,$sqlUpdMovE);
				}
  ...
  case 21: //a�adir referencia temporal
    ...
    $rs=sqlsrv_query($cnx,$sqlAdd);
			...
			echo "<input type=hidden name=cSiglaAutor value=\"".$_POST[cSiglaAutor]."\">";
   			...
   			echo "</html>";
	break;
  case 22: //a�adir referencia de oficina edit
    		$sqlAdMv="INSERT INTO Tra_M_Tramite_Referencias ";
    		$sqlAdMv.="(iCodTramiteRef,				iCodTramite,           cReferencia)";
    		$sqlAdMv.=" VALUES ";
    		$sqlAdMv.="('$_POST[iCodTramiteRef]',	'$_POST[iCodTramite]', '$_POST[cReferencia]')";
    		$rsAdMv=sqlsrv_query($cnx,$sqlAdMv);
    		...
    		echo "<html>";
   			...
   			echo "</html>";
	break;
  case 23: //a�adir movimiento temporal
		$sqlAdd="INSERT INTO Tra_M_Tramite_Temporal ";
    $sqlAdd.="(iCodOficina,              iCodTrabajador,             iCodIndicacion,            cPrioridad,          cCodSession)";
    $sqlAdd.=" VALUES ";
    $sqlAdd.="('$_POST[iCodOficinaMov]','$_POST[iCodTrabajadorMov]','$_POST[iCodIndicacionMov]','$_POST[cPrioridad]','$_SESSION[cCodSession3]')";
    $rs=sqlsrv_query($cnx,$sqlAdd);
    		echo "<html>";
   			echo "<head>";
   			echo "</head>";
   			...
   			echo "</html>";
	break;
  case 24: //a�adir movimiento de oficina edit
    		$sqlAdMv="INSERT INTO Tra_M_Tramite_Movimientos ";
    		$sqlAdMv.="(iCodTramite,           iCodTrabajadorRegistro,             nFlgTipoDoc,  iCodOficinaOrigen,             iCodOficinaDerivar,       iCodTrabajadorDerivar,       iCodIndicacionDerivar,       cPrioridadDerivar,       cAsuntoDerivar,    cObservacionesDerivar,     fFecDerivar,  fFecMovimiento, nEstadoMovimiento, cFlgTipoMovimiento,cFlgOficina)";
    		$sqlAdMv.=" VALUES ";
