...
header("Content-Disposition: attachment; filename=ReportePendientes.xls");
	...
	include_once("../conexion/conexion.php");
       ...
       if($_GET['cCodTipoDoc']!=""){
        ...
        $sqlTra.="AND ((Tra_M_Tramite_Movimientos.iCodOficinaDerivar='$_GET['iCodOficina']' AND ( Tra_M_Tramite_Movimientos.iCodTrabajadorDelegado='$_GET[iCodTrabajador]' OR Tra_M_Tramite_Movimientos.iCodTrabajadorDerivar='$_GET[iCodTrabajador]')) ";
        $sqlTra.="OR (Tra_M_Tramite_Movimientos.iCodOficinaDerivar='$_GET['iCodOficina']' AND Tra_M_Tramite_Movimientos.iCodTrabajadorEnviar='$_GET[iCodTrabajador]') ) ";
