...
<page backtop="15mm" backbottom="10mm" backleft="10mm" backright="10mm">
    <table style="width:400px;border:solid 0px black;">
       <tr>
           <td style="text-align:left;  width: 100%"><img style="width:300px" src="images/pdf_pcm.jpg" alt="Logo"></td>
       </tr>
    </table>
        
    <table style="width:400px;border: solid 0px #585858; border-collapse: collapse" align="left">
       <tr>
           <td style="width:400px;text-align:left; border: solid 0px #585858;font-family:Times">Datos Principales</td>
       </tr>
    </table>
       ...
       <tr>
            ...
            <table style="width:400px;border: solid 0px #585858; border-collapse: collapse">
                <tr>
                    ...
                    <td style="width:265px;text-align:left; border: solid 0px #585858;font-size:12px;font-family:Times"><b><?php echo " ".$Rs[cCodificacion]?></b></td>
                </tr>
                ...
                <tr>
                    ...
                    <?php
                        ...
                        echo date("Y G:i:s", strtotime($Rs['fFecRegistro']));
                    ?>
            </b>        </td>
        </tr>
...
$sqlOfi1="SELECT * FROM Tra_M_Trabajadores,Tra_M_Oficinas WHERE Tra_M_Trabajadores.iCodOficina=Tra_M_Oficinas.iCodOficina AND Tra_M_Trabajadores.iCodTrabajador='$Rs[iCodTrabajadorRegistro]'";
        ...
        <td style="width:265px;text-align:left; border: solid 0px #585858;font-size:12px;font-family:Times"><b>
                <?php
$sqlM1="SELECT TOP 1 * FROM Tra_M_Tramite_Movimientos WHERE iCodTramite='$_GET[iCodTramite]' AND cFlgTipoMovimiento=3 ORDER BY iCodMovimiento ASC";
        ...
        <td style="width:5px;text-align:left; border: solid 0px #585858;font-size:12px">:</td>
        <td style="width:265px;text-align:left; border: solid 0px #585858;font-size:12px;text-transform:uppercase;font-family:Times"><b><?php echo " ".$Rs['cNroDocumento']?></b></td>
        </tr>
        
            <tr>
              <td style="width:130px;height:10px;text-align:left; border: solid 0px #585858;font-size:12px;font-family:Times">Institucion:</td>
              <td style="width:5px;text-align:left; border: solid 0px #585858;font-size:12px">:</td>
              <td style="width:265px;text-align:left; border: solid 0px #585858;font-size:12px;font-family:Times">
              <?php
$sqlRem="SELECT * FROM Tra_M_Remitente WHERE iCodRemitente=$Rs[iCodRemitente]";
    ...
    <tr>
  <td style="width: 410px; text-align:left; border: solid 1px #585858;font-family:Times">
  <?php echo $Rs['cAsunto'];
     if($Rs['iCodTupa']!=""){
    ...
    <table border="1" style="width:400px;border: solid 1px #585858; border-collapse: collapse" align="left">
        ...
        <?php
            $sqlM = "SELECT TOP 1 * FROM Tra_M_Tramite_Movimientos 
                     WHERE iCodTramite='$_GET[iCodTramite]' AND cFlgTipoMovimiento=3 
  ...
  <td style="width:23px;height:20px; text-align: center; border: solid 1px #585858;font-size:10px;font-family:Times">1</td>
