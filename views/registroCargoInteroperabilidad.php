...
$pageTitle = "Registro de Documento Cargo";
$activeItem = "registroCargoInteroperabilidad.php";
$navExtended = true;
                            ...
                            <div class="card-body">
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="text"  class="FormPropertReg" value="<?= $entidad ?>" readonly>
                                        <label class="active">Remitente</label>
                                        </div>
                                    </div>
                                    <div class="row">
