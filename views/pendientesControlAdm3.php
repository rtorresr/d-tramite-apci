...
(		
		 ...
		 WHERE 
				a.iCodOficinaDerivar = 12
			AND a.fFecDerivar > '2013-01-01 00:00:00.000' 
	...
	AND z.fFecDerivar	= 
			   (	SELECT max(w.fFecMovimiento) 
					...
					and w.iCodOficinaDerivar = 12
					AND w.fFecDerivar > '2013-01-01 00:00:00.000' 
						AND  w.nEstadoMovimiento!=5
				)
	and z.iCodOficinaDerivar = 12
";
