<?
/**************************************************************************************
NOMBRE DEL PROGRAMA: iu_tema_pdf.php
SISTEMA: SISTEMA   DE TRÁMITE DOCUMENTARIO DIGITAL
OBJETIVO: Reporte general en PDF de la Tabla Temas
...
<page backtop="25mm" backbottom="10mm" backleft="10mm" backright="10mm">
	...
	<table style="width: 100%; border: solid 0px black;">
	<tr>
	<td style="text-align: left;	width: 50%"><span style="font-size: 15px; font-weight: bold">REPORTE - TEMAS</span></td>
	...
	<table style="width: 80%;border: solid 1px #5544DD; border-collapse: collapse" align="center">
		<thead>
			<tr>
                ...
                <th style="width: 40%; text-align: center; border: solid 1px #6F6F6F; background: #D8D8D8">OFICINA</th>
			</tr>
		</thead>
		<tbody>
	<?	
		...
		else if ($_SESSION['iCodPerfilLogin']==1)
		{
		$oficina=$_GET['iCodOficina'];
		}
		error_log("ERORROOO==>".$_GET['iCodOficina']);
	    $sql=" SP_TEMA_LISTA '%$_GET[cDesTema]%' , '%$oficina%' ,'".$_GET['orden']."' , '".$_GET['campo']."' ";
	...
	?>
        ...
        <td style="width: 40%; text-align: left; border: solid 1px #6F6F6F;font-size:10px"><?php echo $Rs[cNomOficina];?></td>
        </tr>
	<?
        }
    ?>
