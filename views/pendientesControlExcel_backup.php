...
/*	$sqlTra="SELECT * FROM Tra_M_Tramite,Tra_M_Tramite_Movimientos ";
  ...
  $sqlTra.= "'%".$_GET['cAsunto']."%','".$_GET['cCodTipoDoc']."','$_GET['iCodTrabajadorResponsable']','$_GET['iCodTrabajadorDelegado']','".$_GET['iCodTema']."','$_GET['EstadoMov']','$_GET['Aceptado']','$_GET['SAceptado']','$iCodOficina','$campo','$orden' ";
