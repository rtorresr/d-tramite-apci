<?php
session_start();
$pageTitle = "Bandeja de Respondidos - Profesional";
$activeItem = "profesionalRespondidos.php";
$navExtended = true;
     ...
     <div class="container-fluid">
         ...
         <div class="row wow fadeIn">
             ...
             <div class="col-md-12 mb-12">
                 ...
                 <div class="card">
                      <!-- Card header -->
                     <div class="card-header text-center ">BANDEJA DE RESPONDIDOS - PROFESIONAL </div>
                      <!--Card content-->
                                                         ...
                                                         <tr bgcolor="<?=$color?>" onMouseOver="this.style.backgroundColor='#BFDEFF'" OnMouseOut="this.style.backgroundColor='<?=$color?>'">
                                                             <td >
                                                                 <?php if($RsTra['nFlgTipoDoc']==1){?>
                                                                     <a class="modal-trigger tooltipped" data-send="<?=$RsTra['iCodTramite']?>" onclick="getvalue(this)" data-position="left" data-tooltip="Detalle del Trámite" href="#modal1bpr" >
                                                                         <?=$RsTra['cCodificacion']?>
                                                                     </a>
                                                                 ...
                                                                 if($RsTra['nFlgTipoDoc']==4){
                                                                     ?>
                                                                     <a class="modal-trigger tooltipped" data-send="<?=$RsTra['iCodTramiteRel']?>" onclick="getvalue(this)" data-position="left" data-tooltip="Detalle del Trámite" href="#modal1bpr" >
                                                                         <?=$RsTra['cCodificacion']?>
                                                                     </a>
                                                                 ...
                                                                 echo "<div style=color:#727272>".$RsTra['fFecRegistro']->format('G:i')."</div>";
                                                                 /*date("d-m-Y", strtotime($RsTra['fFecRegistro']))*/
                                                             ...
                                                             <td>
                                                                 <?php if($RsTra['cFlgTipoMovimiento']==1){?>
                                                                     <div><?=$RsTra['fFecDerivar']->format('d-m-Y')/*date("d-m-Y", strtotime($RsTra['fFecDerivar']))*/;?></div>
                                                                     <div style="font-size:10px"><?=$RsTra['fFecDerivar']->format('h:i A');?></div>
                                                                 <?php } ?>
                                                                 <?php if($RsTra['cFlgTipoMovimiento']==2){?>
                                                                     <div><?=$RsTra[fFecEnviar]->format('d-m-Y')/*date("d-m-Y", strtotime($RsTra[fFecEnviar]))*/;?></div>
                                                                     <div style="font-size:10px"><?=$RsTra['fFecEnviar']->format('h:i A');?></div>
                                                                 <?php } ?>
                                                             </td>
                                                             <td>
                                                                 <?php     if($RsTra['fFecDelegadoRecepcion']==""){
                                                                     ...
                                                                     echo "<div style=color:#0154AF;font-size:10px>".$RsTra['fFecDelegadoRecepcion']->format('h:i A')."</div>";
                                                                 }
                                                                 ?>
                                                             </td>
                                                             <td>
                                                                 ...
                                                                 if($RsTra['iCodTrabajadorDelegado']!=""){
                                                                     echo "<div style=color:#0154AF>".$RsTra['fFecDelegado']->format('d-m-Y')/*date("d-m-Y", strtotime($RsTra[fFecDelegado]))*/."</div>";
                                                                     echo "<div style=color:#0154AF;font-size:10px>".$RsTra['fFecDelegado']->format('h:i A')."</div>";
                                                                 }
                                                                 ?>
                                                             </td>
                                                             <td>
                                                                 <a href="profesionalData.php?iCodMovimiento=<?=$RsTra['iCodMovimiento']?>&opcion=10"><img src="images/icon_retornar.png" width="16" height="16" border="0" alt="Anular respuesta">
                                                             </td>
                                                         </tr>
                                                         <?php
         }
...
<script Language="JavaScript">
    ...
    function getvalue(e) {
        ...
        const nodocontent= document.querySelector('div#modal1bpr').querySelector('div.modal-content');
