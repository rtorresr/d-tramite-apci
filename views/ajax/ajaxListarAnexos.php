...
$docDigital->obtenerDocDigitalPorId($_POST['iCodDigital']);

if ($docDigital->idDocDigital != null && $docDigital->idDocDigital != 0){
    $datosAnexos = [];

    $datosAnexos['iCodDigital'] = $docDigital->idDocDigital;
    $datosAnexos['cNombreOriginal'] = $docDigital->name;
...
//     $datosAnexos['cNombreNuevo'] = $url_srv.$Rs['cNombreNuevo'];
