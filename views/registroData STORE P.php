...
//  Sql es ejecutado en SP
    $sqlAdd.=" SP_DOC_ENTRADA_INTERNO_INSERT '$cCodificacion',	'".$_SESSION['CODIGO_TRABAJADOR']."', '".$_SESSION['iCodOficinaLogin']."','$_POST[cCodTipoDoc]', '$fFecActual', '$_POST[iCodTrabajadorSolicitado]', '$_POST[cReferencia]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$_POST[nFlgRpta]', '$_POST[nNumFolio]', $fFecPlazo, '$_POST[nFlgEnvio]', '$fFecActual'";
...
//  Sql es ejecutado en SP
    $sqlAdd.=" SP_DOC_SALIDA_INSERT '$cCodificacion',	'".$_SESSION['CODIGO_TRABAJADOR']."', '".$_SESSION['iCodOficinaLogin']."', '$_POST[cCodTipoDoc]', '$fFecActual', '$_POST[iCodTrabajadorSolicitado]', '$_POST[cReferencia]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$_POST[nFlgRpta]', '$_POST[nNumFolio]', $fFecPlazo, '$_POST[cSiglaAutor]', '$fFecActual', '$_POST[iCodRemitente]' ";
...
//  Sql es ejecutado en SP
    ...
    $sqlUpd="SP_DOC_ENTRADA_CON_TUPA_UPDATE  '$_POST[cCodTipoDoc]', '".$_POST['cNroDocumento']."', '$_POST[iCodRemitente]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$_POST[iCodTupaClase]',  '$_POST['iCodTupa']',  '$_POST[cReferencia]',  '$_POST[iCodIndicacion]','$_POST[nNumFolio]', '$_POST[nTiempoRespuesta]', '$_POST[cNomRemite]', '$_POST[iCodTramite]' ";
...
//  Sql es ejecutado en SP
    $sqlUpd="SP_DOC_ENTRADA_SIN_TUPA_UPDATE  '$_POST[cCodTipoDoc]', '".$_POST['cNroDocumento']."', '$_POST[iCodRemitente]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$_POST[cReferencia]',  '$_POST[iCodIndicacion]','$_POST[nNumFolio]', '$_POST[nTiempoRespuesta]', '$_POST[cNomRemite]', '$_POST[iCodTramite]' ";
...
//  Sql es ejecutado en SP
    ...
    $sqlUpd="SP_DOC_ENTRADA_INTERNO_UPDATE '$_POST[cCodTipoDoc]', '$_POST[iCodTrabajadorSolicitado]', '$_POST[cReferencia]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$_POST[nFlgRpta]', '$_POST[nNumFolio]', $fFecPlazo, '$_POST[iCodTramite]' ";
...
//  Sql es ejecutado en SP   	
    $sqlUpd="SP_DOC_SALIDA_UPDATE '$_POST[cCodTipoDoc]', '$_POST[iCodTrabajadorSolicitado]', '$_POST[cReferencia]', '$_POST['cAsunto']', '$_POST[cObservaciones]', '$_POST[nFlgRpta]', '$_POST[nNumFolio]', $fFecPlazo, '$_POST[cSiglaAutor]', $iCodRemitente, '$_POST[iCodTramite]'  ";
