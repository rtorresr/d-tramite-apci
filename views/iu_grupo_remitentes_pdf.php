<?
/**************************************************************************************
NOMBRE DEL PROGRAMA: iu_grupo_remitentes_pdf.php
SISTEMA: SISTEMA  DE TRÁMITE DOCUMENTARIO DIGITAL
OBJETIVO: Reporte general en PDF de la Tabla Grupo de Remitentes
...
<page backtop="25mm" backbottom="15mm" backleft="10mm" backright="10mm">
	...
	<table style="width: 100%; border: solid 0px black;">
	<tr>
	<td style="text-align: left;	width: 50%"><span style="font-size: 15px; font-weight: bold">REPORTE - GRUPO REMITENTES</span></td>
	...
	<table style="width: 80%;border: solid 1px #5544DD; border-collapse: collapse" align="center">
		<thead>
			<tr>
                <th style="width: 50%; text-align: center; border: solid 1px #6F6F6F; background: #D8D8D8">GRUPO</th>
			</tr>
		</thead>
		<tbody>
	<?
	...
	?>
		<tr>
          <td style="width: 30%; text-align: left; border: solid 1px #6F6F6F;font-size:10px"><?php echo $Rs[cDesGrupo];?></td>	
        </tr>
	<?
        }
    ?>
