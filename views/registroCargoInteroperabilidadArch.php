...
$pageTitle = "Archivar Documento";
$activeItem = "registroCargoInteroperabilidadArch.php";
$navExtended = true;
...
if($_SESSION['CODIGO_TRABAJADOR']!=""){
    ...
    <main>
        ...
        <div class="container">
            <form name="frmRegistro" id="frmRegistro" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" id="SIDRECEXT" name="SIDRECEXT" value="<?= isset($_GET['idI']) ? base64_decode($_GET['idI']) : '' ?>">
                <input type="hidden" id="VNUMDOC" name="VNUMDOC" value="<?= isset($_GET['doc']) ? base64_decode($_GET['doc']) : '' ?>">
                <input type="hidden" id="iCodRemitente" name="iCodRemitente" value="<?= isset($_GET['remi']) ? base64_decode($_GET['remi']) : '' ?>">
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                         <div class="col m3 input-field">
                                            <select class="FormPropertReg mdb-select colorful-select dropdown-primary" >
                                            <?php
                                            include_once("../conexion/conexion.php");
                                            $sqlTipo="SELECT cCodTipoDoc,cDescTipoDoc FROM Tra_M_Tipo_Documento WITH(NOLOCK) WHERE cCodTipoDoc=11 ORDER BY cDescTipoDoc ASC";
                                         ...
                                         <div class="col m3 input-field">
                                            <input type="text" id="cNroDocumento" name="cNroDocumento" class="materialize-textarea FormPropertReg" value="<?= isset($_GET['doc']) ? base64_decode($_GET['doc']) : '' ?>" readonly >
                                            <label for="cNroDocumento">N° de Documento</label>
                                        </div>
                                        <div class="col m3 input-field">
                                            <?php
                                            include_once("../conexion/conexion.php");
                                            $valor=isset($_GET['remi']) ? base64_decode($_GET['remi']) :22066;
                                            $sqlEntidad="SELECT [dbo].[fn_NombreEntidad](IdEntidad) as NombreEntidad FROM T_Entidad WITH(NOLOCK) WHERE IdEntidad=$valor";
                                            $rsEntidad=sqlsrv_query($cnx,$sqlEntidad);
                                            while ($RsEntidad=sqlsrv_fetch_array($rsEntidad)){
                                                $entidad=trim($RsEntidad["NombreEntidad"]);
                                            }
                                            sqlsrv_free_stmt($rsEntidad);
                                            ?>
                                            <input type="text" class="materialize-textarea FormPropertReg" value="<?= $entidad ?>" readonly >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col m3 input-field">
                                                <input type="text"  class="materialize-textarea FormPropertReg" value="<?= isset($_GET['cud']) ? base64_decode($_GET['cud']) : '' ?>" readonly >
                                        ...
                                        <!--div class="col m3 input-field">
                                            ...
                                            <label for="fechaDocumento">Fecha Envío</label>
                                        </div-->
                                    ...
                                    <div class="row">
                                        <div class="col m6 input-field">
                                            <textarea id="cAsunto" name="cAsunto"  class="materialize-textarea" style="height: 127px;!important"></textarea>
                                            <label for="cAsunto">Motivo</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col m6 input-field">
    ...
    <script>
       ...
       $('#btnConcluido').on('click',function (e) {
           e.preventDefault();
           setTimeout(function(){ window.location = "interoperabilidad.php?controller=recepcion"; },500);
       });
       ...
       function obtenerDatosFormulario () {
           ...
           formData.append("Evento","registroDocumentoCargoArchivado");
           return formData;
       }
