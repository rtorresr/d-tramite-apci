<?
/**************************************************************************************
NOMBRE DEL PROGRAMA: iu_actualiza_categoria.php
...
<form action="../controllers/ln_actualiza_categoria.php" onSubmit="return validar(this)" method="post" name="form1">
<input name="iCodCategoria" type="hidden" id="iCodCategoria" value="<?php echo $Rs[iCodCategoria]; ?>">
<input name="cDesCategoria2" type="hidden" id="cDesCategoria2" value="<?php echo $Rs[cDesCategoria]; ?>">
      ...
      <td height="91" colspan="4">
        ...
        <table border="0">
           <tr>
              ...
              <td >Descripcion de Categor�a:</td>
              <input name="cDesCategoria" type="text" id="cDesCategoria"  maxlength="30" value="<?php echo trim($Rs[cDesCategoria]); ?>" size="40" class="FormPropertReg form-control">
