...
<table width="600" border="0"  align="center">
  ...
  <tr>
    <td class="headCellColum" colspan="2" class="style1"><div align="center">Ingrese datos de Trabajador</div></td>
...
$rsPer=sqlsrv_query($cnx,$sqlPer);
	?>
     <select name="nCodPerfil" id="nCodPerfil"  />
	  ...
	  <? while ($RsPer=sqlsrv_fetch_array($rsPer)){
	  	if($RsPer["nCodPerfil"]==$_POST[nCodPerfil]){
          		$selecClas="selected";
          	}Else{
          		$selecClas="";
          	}
  ...
  <tr>
    ...
    <td><input name="cNombresTrabajador" type="text" id="cNombresTrabajador" value="<?php echo $Rs[cNombresTrabajador]; ?>"></td>
  </tr>
  <tr>
    <td>Apellidos de Trabajador</td>
    <td><input name="cApellidosTrabajador" type="text" id="cApellidosTrabajador" value="<?php echo $Rs[cApellidosTrabajador]; ?>"></td>
  </tr>
  <tr>
...
$rsDoc=sqlsrv_query($cnx,$sqlDoc);
  ...
  <tr>
    ...
    <td><input name="cNumDocIdentidad" type="text" id="cNumDocIdentidad" value="<?php echo $Rs[cNumDocIdentidad]; ?>"></td>
  </tr>
  <tr>
    <td>Direccion</td>
    <td><input name="cDireccionTrabajador" type="text" id="cDireccionTrabajador" value="<?php echo $Rs[cDireccionTrabajador]; ?>"></td>
  </tr>
  <tr>
    <td>E-MAIL</td>
    <td><input name="cMailTrabajador" type="text" id="cMailTrabajador" value="<?php echo $Rs[cMailTrabajador]; ?>"></td>
  </tr>
  <tr>
    <td>Telefono 1</td>
    <td><input name="cTlfTrabajador1" type="text" id="cTlfTrabajador1" value="<?php echo $Rs[cTlfTrabajador1]; ?>"></td>
  </tr>
  <tr>
    <td>Telefono 2</td>
    <td><input name="cTlfTrabajador2" type="text" id="cTlfTrabajador2" value="<?php echo $Rs[cTlfTrabajador2]; ?>"></td>
  </tr>
  <tr>
    <td>Estado</td>
    ...
    <tr>
    <td colspan="2" align="center"><input name="Insert Trabajador" type="submit" id="Insert Trabajador" value="Actualizar Datos"></td>
    </tr>
</table>
