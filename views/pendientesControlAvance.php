			...
			<tr>
						...
						<fieldset>
							<table cellpadding="3" cellspacing="3" border="0" width="580">
								<?php
									...
									$sqlMov = "SELECT * FROM Tra_M_Tramite_Movimientos WHERE iCodMovimiento='$_POST['iCodMovimientoAccion']'";
									$rsMovData = sqlsrv_query($cnx,$sqlMov);
									$RsMovData = sqlsrv_fetch_array($rsMovData);
		
									$sqlAvn = "SELECT * FROM Tra_M_Tramite_Avance 
              	...
              	<tr>
									<td width="120" valign="top" align="right" width="160">
										<?php
											$rsTrbA = sqlsrv_query($cnx,"SELECT * FROM Tra_M_Trabajadores 
																						 WHERE iCodTrabajador='$RsAvn[iCodTrabajadorAvance]'");
              ...
              ?>
	                ...
	                <?php
			            ...
			            ?>	
							...
							&nbsp;&nbsp;
							<button class="btn btn-primary" onclick="window.open('pendientesControl.php', '_self'); return false;" onMouseOver="this.style.cursor='hand'"> <b>Cancelar</b> <img src="images/icon_retornar.png" width="17" height="17" border="0"> </button>
							</td>
							</tr>
							</form>
