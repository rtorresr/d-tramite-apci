...
<head>
    ...
    function Registrar(){
      ...
      document.frmRegistro.opcion.value=32;
      document.frmRegistro.action="registroData.php";
      document.frmRegistro.submit();
    }
                         ...
                         <div class="card-body">
                            ...
                            <table class="table">
                                <?php
                                    ...
                                    $sqlEmail = "SELECT iCodTrabajador, cMailTrabajador FROM Tra_M_Trabajadores 
                                                           WHERE iCodOficina = ".$_SESSION['iCodOficinaLogin']." AND iCodCategoria = 5";
                                ...
                                <form name="frmRegistro" method="POST" action="registroData.php" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="id_identificador" value="<?php echo rand(100000000,999999999);?>">
                                        ...
                                        <td class="FondoFormRegistro">
                                            <table border=0>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="reloj" class="FormPropertReg form-control" style="width:120px"
                                                                     onfocus="window.document.frmRegistro.reloj.blur()">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td valign="top">
                                                        <textarea name="cObservaciones" style="width:290px;height:55px" class="FormPropertReg form-control"><?php echo $_POST['cObservaciones']??''; ?></textarea>
                                                    </td>
                                                    <td valign="top" >Folios:</td>
                                                    <td valign="top">
                                                        <input type="text" name="nNumFolio" value="<?php if(!isset($_POST['nNumFolio'])){echo 1;} else { echo $_POST['nNumFolio'];}?>" class="FormPropertReg form-control" style="width:40px;text-align:right"  maxlength="3" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
                                                    </td>
                                                </tr>
                                                <tr>
                                                        ...
                                                        <table border=0>
                                                            <tr>
                                                                <td align="center" style="background:#dedede;">
                                                                    ...
                                                                    <input type="hidden" id="iCodTramiteRef" name="iCodTramiteRef"  value="<?=$_POST['iCodTramiteRef']??''?>">
                                                                </td>
                                                                <td align="center">
                                                                    <div class="btn btn-primary" style="width:125px;height:17px;padding-top:4px;">
                                                                        <a style=" text-decoration:none" href="javascript:;" onClick="Buscar();">Añadir Referencia
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table border=0>
                                                            ...
                                                            <tr>
                                                                <?php
                                                                    ...
                                                                    if ($RsJefe['iCodCategoria'] == 5) { // El jefe de la oficina tiene código categoría 5
                                                                        $valor = 1;
                                                                    }else{
                                                                        $valor = 0;
                                                                    }
                                                                ?>
                                                                <!-- <input type="hidden" name="nFlgEnvio" value="<?//php echo $valor; ?>"> -->
                                                                ...
                                                                <td valign="top">
                                                                    ...
                                                                    <option value="">Seleccione:</option>
                                                                        <?php
                                                                                $sqlTipo = "select iCodTrabajador, cNombresTrabajador, cApellidosTrabajador from [dbo].[Tra_M_Trabajadores] where iCodOficina='".$_SESSION['iCodOficinaLogin']."' order by cApellidosTrabajador asc";
                                                                            $rsTipo = sqlsrv_query($cnx,$sqlTipo);
                                                                            while ($RsTipo = sqlsrv_fetch_array($rsTipo)){
                                                                                ...
                                                                                echo utf8_encode("<option value=".$RsTipo["iCodTrabajador"]." ".$selecTipo.">".$RsTipo["cApellidosTrabajador"].", ".$RsTipo["cNombresTrabajador"]."</option>");
                                                                            }
                                                                            sqlsrv_free_stmt($rsTipo);
                                                                    ?>
                                                                </select>
                                                                ...
                                                                <td colspan="3" align="left">
                                                                    ...
                                                                    <div  id="areaOficina">
                                                                            <table border=0>
                                                                                <tr>
                                                                                    <td>
                                                                                        <select name="iCodOficinaResponsable" id="iCodOficinaMov" style="width:280px;" class="FormPropertReg form-control"
                                                                                    ...
                                                                                    <td>
                                                                                        <select name="iCodTrabajadorResponsable" id="responsable" style="width:220px;" class="FormPropertReg form-control">
                                                                                    ...
                                                                                    <td>
                                                                                        <select name="cPrioridad" id="cPrioridad" class="size9" style="width:100px;background-color:#FBF9F4">
                                                                                    ...
                                                                                    <td>
                                                                                    <input name="button" type="button" class="btn btn-primary" value="Añadir" onclick="insertarMovimientoTemporal();">
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <td colspan="4"> <input name="button" type="button" class="btn btn-primary" style="font-size: 12px;height: 29px;width: 100px;" value="Registrar" onclick="Registrar();"> </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="4" style="padding-left:15px">
                                                                    ...
                                                                    <a href="javascript:void(0);" class="majorpoints btn-default1 btn1" style="cursor:not-allowed">Documento electrónico</a>
                                                            ...
                                                            <tr>
                                                                <td colspan="4">
                                                                        ...
                                                                        <input name="button" type="button" class="btn btn-primary" value="Finalizar"
                ...
                success: function(list){
                    ...
                    $.each(list,function(index,value)
                    {
                        if (value.iCodCategoria == 5){
                            opcion = opcion + "<option value='"+ value.iCodTrabajador + "' selected>";
                        }else{
                            opcion = opcion + "<option value='"+ value.iCodTrabajador + "'>";
                        }
                        ...
                        opcion = opcion + value.cNombresTrabajador + " " + value.cApellidosTrabajador + " " + value.encargado;
                        opcion = opcion + "</option>";
                    });
                    $('#responsable').html(opcion);
            ...
            $.ajax({
                ...
                success: function(list){
                    ...
                    $.each(list,function(index,value)
                    {
                        ...
                        itemss += '<tr>'
                        itemss += '<td align="left">'+value.cNomOficina+'</td>'
                        itemss += '<td align="left">'+value.cNombresTrabajador+' '+value.cApellidosTrabajador+' '+value.encargado+'</td>'
                        itemss += '<td align="left">'+value.cIndicacion+'</td>'
                        itemss += '<td align="left">'+value.cPrioridad+'</td>'
                        itemss += '<td><input type="checkbox" name="Copia[]" value="'+value.iCodTemp+'"/></td>'
                        itemss += '<td align="center"><a href="javascript: void(0)" onclick="eliminarMovimientoTemporal('+value.iCodTemp+')"><img src="images/icon_del.png" border="0" width="16" height="16"></a></td>'
                        itemss += '</tr>'
                    });
                    $("#listaMovimientoTemporal").html(itemss);
                },
                error: function(e){
                    console.log(e);
